 ...
 */
const PAD_SAFE_BOTTOM: Record<ScrollPadding, string> = {
 ...
 * room it was given.
 */
export const ScrollAreaV4 = React.forwardRef<HTMLDivElement, ScrollAreaV4Props>(
  function ScrollAreaV4(
    { axis = 'vertical', padding = 'lg', filled = false, safeArea = false, className, ...rest },
    ref
  ) {
    return (
      <div
        ...
        className={cn(
          ...
          padding === 'none' ? undefined : SPACE_P[padding],
          safeArea ? PAD_SAFE_BOTTOM[padding] : undefined,
