 ...
 */
export const EmptyStateV4 = React.forwardRef<HTMLDivElement, EmptyStateV4Props>(
  function EmptyStateV4({ kind, icon, title, description, action, ...rest }, ref) {
