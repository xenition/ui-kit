...
export const MONEY_V4_STYLE_ID = 'xen-v4-commerce-money-styles';
 ...
 */
export const MONEY_V4_GROUND_ATTR = 'data-xen-v4-money-ground';
 ...
 */
export const MONEY_V4_CSS = `
[data-xen-v4-card][${MONEY_V4_GROUND_ATTR}="card"] {
 ...
 * above it.
 */
export const SUMMARY_ROW_CLASS = [
 ...
 */
export const SUMMARY_RULE_CLASS = 'h-px w-full shrink-0 bg-border';
