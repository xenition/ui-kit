...
import { EASE_STANDARD, V4_MOTION, transitionCss } from '../primitives/internal/v4-motion';
 ...
 */
const RESET_TRANSITION = transitionCss(['transform'], V4_MOTION.standard, EASE_STANDARD);
 ...
 */
export const TiltCardV4 = React.forwardRef<HTMLDivElement, TiltCardV4Props>(function TiltCardV4(
