 ...
 * not to introduce.
 */
export const MessageListV4 = React.forwardRef<HTMLDivElement, MessageListProps>(
  function MessageListV4({ className, children, ...rest }, ref) {
    return (
      <div
        ref={ref}
        ...
        role="log"
        data-xen-v4-message-list=""
        className={cn(
          'flex flex-1 flex-col gap-sm overflow-y-auto overscroll-contain p-lg',
          className
        )}
        {...rest}
      >
