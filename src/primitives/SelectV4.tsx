 ...
 */
export const SelectV4 = React.forwardRef<HTMLSelectElement, SelectProps>(function SelectV4(
  { className, invalid = false, style, children, ...rest },
  ref
) {
  ...
  return (
    <select
      ...
      className={cn(FIELD_V4_SHELL, fieldBorderClass(invalid), className)}
