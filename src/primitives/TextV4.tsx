 ...
 */
const TRACKING_CLASS: Record<TextSize, string> = {
  xs: 'tracking-[0.01em]',
  sm: 'tracking-[0.005em]',
  base: 'tracking-[0em]',
  lg: 'tracking-[0em]',
 ...
 */
export const TextV4 = React.forwardRef<HTMLSpanElement, TextV4Props>(function TextV4(
  {
    size = 'base',
    tone = 'onSurface',
    weight = 'regular',
  ...
  return (
    <span
      ref={ref}
      data-xen-v4-text={size}
      className={cn(
        resolvedFace === 'heading' ? 'font-heading' : 'font-body',
        SIZE_CLASS[size],
        LEADING_CLASS[size],
        TRACKING_CLASS[size],
        TONE_CLASS[tone],
        WEIGHT_CLASS[weight],
        ALIGN_CLASS[align],
        display && BALANCE_CLASS,
        measure && MEASURE_CLASS,
        numeric === 'tabular' && TABULAR_CLASS,
        className
      )}
