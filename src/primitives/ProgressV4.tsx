 ...
 */
const TONE: Record<ProgressTone, { track: string; fill: string }> = {
  primary: { track: tintArbitrary(TONE_SLOTS.info.fill), fill: 'bg-primary' },
  success: { track: tintArbitrary(TONE_SLOTS.success.fill), fill: 'bg-success' },
  warn: { track: tintArbitrary(TONE_SLOTS.warn.fill), fill: 'bg-warn' },
  danger: { track: tintArbitrary(TONE_SLOTS.danger.fill), fill: 'bg-danger' },
};
