 ...
 */
export const AVATAR_DIAMETER: Record<AvatarSize, string> = {
  xs: 'var(--xen-space-lg)',
  sm: 'var(--xen-space-xl)',
 ...
 */
export const MONOGRAM_CLASS: Record<AvatarSize, string> = {
  xs: 'text-xs',
  sm: 'text-sm',
  md: 'text-base',
  lg: 'text-xl',
...
export const AVATAR_SHAPE: Record<AvatarShape, string> = {
  circle: 'rounded-full',
 ...
 */
export const EYEBROW_TRACKING_CLASS = 'tracking-[0.18em]';
