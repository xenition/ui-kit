...
export const V4_CARD_GROUND_STYLE_ID = 'xen-v4-card-ground-styles';

/** Spread onto a `CardV4` to opt it into the card ground. */
export const V4_CARD_GROUND_ATTR = { 'data-xen-v4-ground': 'card' } as const;
 ...
 */
export const V4_CARD_GROUND_CSS = `
