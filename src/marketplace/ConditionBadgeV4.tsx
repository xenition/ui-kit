...
import type { BadgeProps, BadgeTone } from '../primitives/Badge';
 ...
 */
export const ConditionBadgeV4 = React.forwardRef<HTMLSpanElement, ConditionBadgeV4Props>(
  function ConditionBadgeV4(
    {
      condition,
      variant = 'soft',
      size = 'md',
    ...
    return (
      <BadgeV4
        ...
        variant={variant}
        size={size}
        data-xen-v4-condition-badge={condition}
