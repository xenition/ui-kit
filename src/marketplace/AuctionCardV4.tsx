...
export const AUCTION_CARD_V4_STYLE_ID = 'xen-v4-auction-card-styles';
 ...
 */
export const AUCTION_CARD_V4_CSS = `
 ...
 */
export const AuctionCardV4 = React.forwardRef<HTMLDivElement, AuctionCardV4Props>(
  function AuctionCardV4(
    {
      title,
      currentBidCents,
      currency = 'USD',
    ...
    injectStyleOnce(AUCTION_CARD_V4_STYLE_ID, AUCTION_CARD_V4_CSS);
    ...
    */
    ...
    const timer = (
      <BadgeV4
        ...
        aria-hidden="true"
        data-xen-v4-auction-countdown={ended ? 'ended' : urgent ? 'urgent' : 'live'}
    ...
    */
    const timerSlot = (
      <span data-xen-v4-auction-timer="" className="inline-flex shrink-0 items-center">
        {timer}
        <span
          data-xen-v4-auction-announce=""
          className="sr-only"
          aria-live="polite"
          aria-atomic="true"
        >
    ...
    const media = compact ? null : (
      ...
      >
        ...
        <div className="absolute right-sm top-sm">{timerSlot}</div>
      </div>
    );
    ...
    return (
      <CardV4
        ref={ref}
        data-xen-v4-auction-card={variant}
      ...
      >
        ...
        <div className="flex flex-col gap-sm p-lg">
          ...
          {onPlaceBid != null ? (
            <ButtonV4 variant="primary" onClick={onPlaceBid} disabled={ended}>
