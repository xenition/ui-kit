 ...
 * not a decorated one.
 */
const PRICE: Record<Size, 'base' | 'lg' | '2xl'> = { sm: 'base', md: 'lg', lg: '2xl' };
 ...
 */
const WAS: Record<Size, 'xs' | 'sm' | 'base'> = { sm: 'xs', md: 'sm', lg: 'base' };
...
export function PriceTagV4({
  ...
  return (
    <View style={[{ flexDirection: 'row', alignItems: 'baseline', gap: tokens.spacing.xs }, style]}>
      <Text
        style={{
