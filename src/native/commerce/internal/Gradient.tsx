/**
 * Thin wrapper over the OPTIONAL `expo-linear-gradient` peer. Every consumer
 * is an Expo app (so the real native gradient is present), but the dependency
 * is loaded lazily and degrades to a **solid token color** if absent — the
 * kit never hard-requires a native module. Colors passed in always come from
 * theme tokens.
 */
