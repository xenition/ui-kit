...
export function SectionCardV4({
  ...
  children,
  ...rest
}: SectionCardV4Props): React.ReactElement | null {
  ...
  */
  ...
  return (
    ...
    >
      {hasHeader ? (
        <View
          testID="xen-v4-section-card-header"
          style={{
            flexDirection: 'row',
      ...
      */}
      {divided && hasHeader && hasBody ? (
        <ListSeparatorV4 testID="xen-v4-section-card-rule" />
      ) : null}

      <View
        testID="xen-v4-section-card-body"
        style={
          grouped
            ? null
            : {
