...
export function ColumnChartV4({
  ...
  accessibilityLabel,
  style,
}: ColumnChartV4Props): React.ReactElement {
  ...
  return frame(
    <Animated.View
      ...
      style={{ gap: tokens.spacing.sm, opacity: progress }}
    >
      {data.map((d, i) => {
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/*
                A direct label is simply there; a label the press reveals is a
                reveal, and takes the line's shared readout fade. Same node and
                same testID either way, so the two are one label with two
                reasons to be on screen.
              */}
              {showValue ? (
                directLabels ? (
            ...
            <View style={{ flexDirection: 'row', alignItems: 'stretch' }}>
              ...
              */}
              <View testID="xen-v4-chart-axis" style={{ width: 1, backgroundColor: palette.axis }} />
              <View
