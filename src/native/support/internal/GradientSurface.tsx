...
/**
 * A token-fed gradient ground for the support module's V4 "console" line.
 ...
 * here. Used only on the peak moments (open-ticket header, agent stats, CSAT
 * results) so the agent console itself stays calm and legible.
 */
...
/** Diagonal by default — a calm, confident wash. */
