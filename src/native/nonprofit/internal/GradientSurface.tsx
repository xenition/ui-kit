...
/**
 * A token-fed gradient ground for the nonprofit module's V4 "rally" line.
 ...
 * here. Used for the rally moment (the thank-you celebration) and any hero
 * scrims, so the cards, meters, and rows themselves stay clean.
 */
...
/** Diagonal by default — a warm, celebratory wash. */
