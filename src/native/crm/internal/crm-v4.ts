 ...
 */
export function toneInkOf(theme: XenitionNativeTheme, tone: CrmTone): string {
 ...
 */
export function toneOnOf(theme: XenitionNativeTheme, tone: CrmTone): string {
  return onPair(theme, tone as ToneV4);
}
