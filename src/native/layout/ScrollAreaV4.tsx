...
export function ScrollAreaV4({
  ...
  children,
  ...rest
}: ScrollAreaV4Props): React.ReactElement {
  ...
  return (
    <ScrollView
      horizontal={horizontal ?? axis === 'horizontal'}
      style={[filled ? { backgroundColor: colors.surface } : null, style]}
      contentContainerStyle={[{ padding: pad, paddingBottom: bottom }, contentContainerStyle]}
      {...rest}
    >
      {children}
    </ScrollView>
