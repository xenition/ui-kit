...
import { chordLabel, withAlpha, type Chord } from './types';
...
const SIZE: Record<ChordChipSize, { padV: number; padKey: 'xs' | 'sm' | 'md'; text: 'xs' | 'sm' | 'base' }> = {
...
export function ChordChip({
  ...
  onPress,
  style,
}: ChordChipProps): React.ReactElement {
