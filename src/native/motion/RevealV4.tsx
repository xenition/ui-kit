...
import {
  ...
  EASING_STANDARD,
  V4_MOTION,
} from '../primitives/internal/motion-v4';
...
export function RevealV4({
  ...
  style,
}: RevealV4Props): React.ReactElement {
  ...
  React.useEffect(() => {
    ...
    const animation = Animated.timing(anim, {
      ...
      duration: reduced ? V4_MOTION.standard : duration,
      delay: totalDelay,
  ...
  return (
    <Animated.View testID="xen-v4-reveal" style={[{ opacity: anim, transform }, style]}>
      {children}
    </Animated.View>
  );
}
