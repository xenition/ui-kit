...
/**
 * A token-fed gradient ground for the social module's V4 "feed" line.
 ...
 * here. Used for the identity moments (profile header, story viewer, story
 * rings) so the feed cards and rows themselves stay clean.
 */
...
/** Diagonal by default — a soft social wash. */
