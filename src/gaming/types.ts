 ...
 */
export function rarityColorKey(rarity?: ItemRarity): RaritySlot {
  switch (rarity) {
    case 'legendary':
      return 'warn';
    case 'epic':
...
export const RARITY_TEXT_CLASS: Record<RaritySlot, string> = {
  muted: 'text-muted',
...
export const RARITY_BORDER_CLASS: Record<RaritySlot, string> = {
  muted: 'border-border',
