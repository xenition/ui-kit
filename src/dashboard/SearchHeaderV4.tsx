 ...
 * the query on mount.
 */
export const SearchHeaderV4 = React.forwardRef<HTMLInputElement, SearchHeaderV4Props>(
  function SearchHeaderV4(
    {
      value,
      onChangeText,
      placeholder = 'Search',
    ...
    return (
      <div
        data-xen-v4-search-header=""
        data-divided={divided ? '' : undefined}
        className={cn(
          'flex flex-row items-center gap-[var(--xen-space-sm)]',
          // §4.4 — off by default. The hairline is opt-in, not the house style.
          divided && 'border-b border-border pb-[var(--xen-space-md)]',
          className
        )}
      >
