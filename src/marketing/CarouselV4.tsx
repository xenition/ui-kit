 ...
 */
export const CarouselV4 = React.forwardRef<HTMLDivElement, CarouselV4Props>(function CarouselV4(
  { items, arrows = true, dots = true, autoplay = 0, label = 'Carousel', className, children, ...rest },
  ref
) {
      ...
      {arrows && count > 1 ? (
        <>
          <button
            ...
            onClick={prev}
            className={cn(
              'absolute left-[var(--xen-space-sm)] top-1/2 -translate-y-1/2 inline-flex h-11 w-11 items-center justify-center',
              'rounded-[var(--xen-radius-full)] border border-border bg-surface text-on-surface shadow-md transition-colors',
          ...
          <button
            ...
            onClick={next}
            className={cn(
              'absolute right-[var(--xen-space-sm)] top-1/2 -translate-y-1/2 inline-flex h-11 w-11 items-center justify-center',
              'rounded-[var(--xen-radius-full)] border border-border bg-surface text-on-surface shadow-md transition-colors',
              'hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300'
            )}
          >
