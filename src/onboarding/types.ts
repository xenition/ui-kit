/**
 * Shared data shapes for the `@xenition/ui/onboarding` module (web / React DOM
 * parity of `@xenition/ui/native/onboarding`). These are plain, presentational
 * contracts — the app owns the data and passes it in; nothing here fetches or
 * persists. Copy is caller-supplied so hosts stay in control of localization and
 * outcome-oriented wording (design.md §47).
 */
