 ...
 */
exports.CommentItemV4 = React.forwardRef(function CommentItemV4({ author, handle, avatarUrl, text, timestamp, likeCount = 0, liked = false, depth = 0, pinned = false, onLike, onReply, onPressAuthor, onPressMention, onPressHashtag, children, className, style, ...rest }, ref) {
    const safeDepth = Math.max(0, depth);
    const indentStyle = safeDepth > 0 ? { paddingLeft: `calc(${safeDepth} * var(--xen-space-xl))` } : undefined;
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, className: className, style: indentStyle ? { ...indentStyle, ...style } : style, ...rest, children: [(0, jsx_runtime_1.jsxs)("div", { className: (0, cn_1.cn)('flex gap-sm rounded-[var(--xen-radius-lg)]', pinned && 'bg-primary/10 p-sm'), children: [onPressAuthor ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": author, onClick: onPressAuthor, className: "shrink-0", children: (0, jsx_runtime_1.jsx)(Avatar_1.Avatar, { src: avatarUrl, name: author, size: "md" }) })) : ((0, jsx_runtime_1.jsx)(Avatar_1.Avatar, { src: avatarUrl, name: author, size: "md", className: "shrink-0" })), (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-1 flex-col gap-xs", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-center gap-xs", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-sm font-bold text-on-surface", children: author }), handle ? (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-muted", children: ["@", handle] }) : null, timestamp ? (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-muted", children: ["\u00B7 ", timestamp] }) : null, pinned ? (0, jsx_runtime_1.jsx)("span", { className: "text-xs font-semibold text-primary", children: "\u00B7 Pinned" }) : null] }), (0, jsx_runtime_1.jsx)(MentionText_1.MentionText, { text: text, size: "sm", onPressMention: onPressMention, onPressHashtag: onPressHashtag }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-lg", children: [(0, jsx_runtime_1.jsxs)("button", { type: "button", "aria-label": `Like, ${likeCount}`, "aria-pressed": liked, disabled: !onLike, onClick: onLike, className: (0, cn_1.cn)('inline-flex items-center gap-xs text-sm transition-opacity hover:opacity-70', 'disabled:pointer-events-none', liked ? 'text-primary' : 'text-muted'), children: [(0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", children: liked ? '♥' : '♡' }), likeCount > 0 ? (0, jsx_runtime_1.jsx)("span", { className: "text-xs font-semibold", children: likeCount }) : null] }), onReply ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "Reply", onClick: onReply, className: "text-xs font-semibold text-primary transition-opacity hover:opacity-70", children: "Reply" })) : null] })] })] }), children ? (0, jsx_runtime_1.jsx)("div", { className: "mt-sm flex flex-col gap-sm", children: children }) : null] }));
});
