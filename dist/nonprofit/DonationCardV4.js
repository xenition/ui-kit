 ...
 * classes (no literals).
 */
exports.DonationCardV4 = React.forwardRef(function DonationCardV4({ title, description, presets = [], selected, currency = 'USD', ctaLabel = 'Donate', variant = 'default', onSelectAmount, onDonate, loading = false, disabled = false, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, role: "group", "aria-label": title, className: (0, cn_1.cn)('flex flex-col gap-md', container, isCompact ? 'p-md' : 'p-lg', className), ...rest, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-xs", children: [(0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('font-bold text-on-surface', isFeatured ? 'text-xl' : 'text-lg'), children: title }), description ? (0, jsx_runtime_1.jsx)("span", { className: "text-sm text-muted", children: description }) : null] }), presets.length > 0 ? ((0, jsx_runtime_1.jsx)("div", { role: "radiogroup", "aria-label": "Gift amount", className: "flex flex-wrap gap-sm", children: presets.map((cents, i) => {
                    const isOn = cents === active;
                    return ((0, jsx_runtime_1.jsx)("button", { type: "button", role: "radio", "aria-checked": isOn, "aria-label": (0, internal_1.formatMoney)(cents, currency), disabled: disabled, onClick: () => onSelectAmount?.(cents), className: (0, cn_1.cn)('min-h-[44px] rounded-full px-md py-sm text-base font-bold transition-colors', 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary', 'disabled:pointer-events-none disabled:opacity-50', isOn
                            ? 'border-2 border-primary bg-primary/10 text-primary'
                            : 'border border-border bg-surface text-on-surface hover:bg-primary/10'), children: (0, internal_1.formatMoney)(cents, currency) }, i));
