...
exports.FundraiserCardV2 = React.forwardRef(function FundraiserCardV2({ title, organizerName, organizerAvatarUrl, imageUrl, imageAlt, raisedCents, goalCents, currency = 'USD', donorCount, variant, onDonate, onShare, loading = false, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-fundraiser-card": "", className: (0, cn_1.cn)('overflow-hidden rounded-lg bg-surface shadow-md', className), ...rest, children: [(0, jsx_runtime_1.jsxs)("div", { className: "relative h-32 bg-neutral-100", children: [imageUrl ? ((0, jsx_runtime_1.jsx)("img", { src: imageUrl, alt: imageAlt ?? title, className: "h-full w-full object-cover" })) : ((0, jsx_runtime_1.jsx)("div", { className: "flex h-full w-full items-center justify-center text-4xl", children: "\uD83D\uDC9D" })), (0, jsx_runtime_1.jsx)("div", { className: "absolute -bottom-5 left-3 flex items-center gap-2", children: (0, jsx_runtime_1.jsx)("div", { className: "rounded-full border-2 border-surface", children: (0, jsx_runtime_1.jsx)(Avatar_1.Avatar, { src: organizerAvatarUrl, name: organizerName, size: "md" }) }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-2 px-md pb-md pt-7", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("p", { className: "text-base font-bold text-on-surface", children: title }), (0, jsx_runtime_1.jsxs)("p", { className: "text-xs text-muted", children: ["by ", organizerName] })] }), (0, jsx_runtime_1.jsx)(CampaignProgressV2_1.CampaignProgressV2, { raisedCents: raisedCents, goalCents: goalCents, currency: currency, donorCount: donorCount }), (0, jsx_runtime_1.jsxs)("div", { className: "flex gap-2", children: [onDonate ? ((0, jsx_runtime_1.jsx)(Button_1.Button, { size: "md", variant: "primary", className: "flex-1", onClick: onDonate, children: "Donate" })) : null, onShare ? ((0, jsx_runtime_1.jsx)(Button_1.Button, { size: "md", variant: "outline", onClick: onShare, children: "Share" })) : null] })] })] }));
});
