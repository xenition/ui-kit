 ...
 */
export interface FullScreenPlayerProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSeek'> {
 ...
 */
export declare const FullScreenPlayer: React.ForwardRefExoticComponent<FullScreenPlayerProps & React.RefAttributes<HTMLDivElement>>;
