 ...
 */
exports.MiniPlayerV4 = React.forwardRef(function MiniPlayerV4({ track, state = 'paused', progress = 0, variant = 'bar', onPlayToggle, onNext, onClick, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-mini-player": "", role: interactive ? 'button' : undefined, tabIndex: interactive ? 0 : undefined, "aria-label": interactive ? `Now playing: ${track.title}. Expand` : undefined, onClick: interactive ? () => onClick(track) : undefined, onKeyDown: interactive
            ...
            : undefined, className: (0, cn_1.cn)('relative flex items-center gap-[var(--xen-space-sm)] overflow-hidden border border-border bg-surface shadow-lg', 'px-[var(--xen-space-sm)] py-[var(--xen-space-sm)]', floating ? 'rounded-[var(--xen-radius-lg)]' : 'rounded-[var(--xen-radius-lg)]', interactive &&
            'cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300', className), ...rest, children: [(0, jsx_runtime_1.jsx)("div", { className: "absolute inset-x-0 top-0 h-1 bg-primary-100", children: (0, jsx_runtime_1.jsx)("div", { className: "h-1 bg-primary", style: { width: `${frac * 100}%` } }) }), track.artworkUrl ? ((0, jsx_runtime_1.jsx)("img", { src: track.artworkUrl, alt: "", "aria-hidden": "true", className: "h-11 w-11 shrink-0 rounded-[var(--xen-radius-md)] bg-border object-cover" })) : ((0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: "flex h-11 w-11 shrink-0 items-center justify-center rounded-[var(--xen-radius-md)] bg-accent", children: (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: "\u266A", size: "base", color: "onPrimary" }) })), (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-1 flex-col", children: [(0, jsx_runtime_1.jsx)("span", { className: "truncate text-sm font-bold text-on-surface", children: track.title }), track.artist ? ((0, jsx_runtime_1.jsx)("span", { className: "truncate text-xs text-muted", children: track.artist })) : null] }), isBuffering ? ((0, jsx_runtime_1.jsx)("span", { className: "inline-flex h-11 w-11 items-center justify-center", children: (0, jsx_runtime_1.jsx)(primitives_1.Spinner, { size: "sm" }) })) : ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": isPlaying ? 'Pause' : 'Play', "aria-pressed": isPlaying, disabled: !onPlayToggle, onClick: (e) => {
                    e.stopPropagation();
                    onPlayToggle?.(!isPlaying);
                }, className: (0, cn_1.cn)('flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-primary text-on-primary', 'transition-opacity hover:opacity-90', 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300', 'disabled:pointer-events-none disabled:opacity-50'), children: (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: isPlaying ? '❙❙' : '▶', size: "sm", color: "onPrimary" }) })), onNext ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "Next", onClick: (e) => {
                    e.stopPropagation();
                    onNext();
