 ...
 */
exports.PodcastCard = React.forwardRef(function PodcastCard({ podcast, subscribed = false, variant = 'grid', onClick, onSubscribeToggle, className, ...rest }, ref) {
    ...
    const meta = [
        ...
        .filter(Boolean)
        .join(' · ');
    const artwork = podcast.artworkUrl ? ((0, jsx_runtime_1.jsx)("img", { src: podcast.artworkUrl, alt: "", "aria-hidden": "true", className: (0, cn_1.cn)('rounded-[var(--xen-radius-md)] bg-border object-cover', list ? '' : 'aspect-square w-full'), style: list ? { width: art, height: art } : undefined })) : ((0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, cn_1.cn)('flex items-center justify-center rounded-[var(--xen-radius-md)] bg-accent', list ? '' : 'aspect-square w-full'), style: list ? { width: art, height: art } : undefined, children: (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: "\uD83C\uDF99", size: "2xl", color: "onPrimary" }) }));
    ...
    const textBlock = ((0, jsx_runtime_1.jsxs)("div", { className: (0, cn_1.cn)('flex flex-col gap-0.5', list && 'min-w-0 flex-1'), children: [(0, jsx_runtime_1.jsx)("span", { className: "text-base font-bold text-on-surface", children: podcast.title }), meta ? (0, jsx_runtime_1.jsx)("span", { className: "truncate text-xs text-muted", children: meta }) : null, featured && podcast.description ? ((0, jsx_runtime_1.jsx)("span", { className: "mt-[var(--xen-space-xs)] text-sm text-muted", children: podcast.description })) : null, featured && subscribeBtn ? ((0, jsx_runtime_1.jsx)("div", { className: "mt-[var(--xen-space-sm)] self-start", children: subscribeBtn })) : null] }));
