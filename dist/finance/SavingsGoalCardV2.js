...
exports.SavingsGoalCardV2 = void 0;
 ...
 */
exports.SavingsGoalCardV2 = React.forwardRef(function SavingsGoalCardV2({ title, savedCents, targetCents, currency = 'USD', deadline, color = 'success', formatMoney: format = money_1.formatMoney, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Card_1.Card, { ref: ref, className: className, ...rest, children: (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-center gap-[var(--xen-space-md)] text-center", children: [(0, jsx_runtime_1.jsx)(ProgressRing_1.ProgressRing, { value: pct * 100, max: 100, size: 132, thickness: 12, color: color, "aria-label": `${title}, ${Math.round(pct * 100)}% saved` }), (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-col items-center gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsx)("p", { className: "truncate text-lg font-bold text-on-surface", children: title }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-baseline gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsx)(MoneyAmount_1.MoneyAmount, { cents: saved, currency: currency, tone: "neutral", size: "md" }), (0, jsx_runtime_1.jsxs)("span", { className: "text-sm text-muted", children: ["/ ", format(target, currency)] })] }), (0, jsx_runtime_1.jsxs)("p", { className: "text-xs text-muted", children: [format(remaining, currency), " to go", deadline != null ? ` · by ${deadline}` : ''] })] })] }) }));
});
