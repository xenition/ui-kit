...
export interface GenerativeCoverV4Props extends Omit<React.SVGAttributes<SVGSVGElement>, 'children'> {
 ...
 * best-effort.
 */
export declare const GenerativeCoverV4: React.ForwardRefExoticComponent<GenerativeCoverV4Props & React.RefAttributes<SVGSVGElement>>;
