...
exports.COVER_INK_STEPS = exports.COVER_PAPER_STEPS = exports.COVER_FORMS = void 0;
exports.hashSeed = hashSeed;
exports.resolveCoverPlate = resolveCoverPlate;
/**
 ...
 */
exports.COVER_PAPER_STEPS = [500, 600, 700];
/**
 ...
 * other and dissolve.
 */
exports.COVER_INK_STEPS = [200, 300, 400];
/**
 ...
 */
function resolveCoverPlate(seed, form, ink, paper) {
    const hash = hashSeed(seed);
    const paperStep = exports.COVER_PAPER_STEPS[(hash >>> 5) % exports.COVER_PAPER_STEPS.length];
    const inkStep = exports.COVER_INK_STEPS[(hash >>> 13) % exports.COVER_INK_STEPS.length];
    return {
        form: form ?? exports.COVER_FORMS[hash % exports.COVER_FORMS.length],
        ink: ink ?? `accent-${inkStep}`,
        paper: paper ?? `primary-${paperStep}`,
    };
}
//# sourceMappingURL=cover-v4.js.map