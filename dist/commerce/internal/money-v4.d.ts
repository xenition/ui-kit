...
export declare const MONEY_V4_STYLE_ID = "xen-v4-commerce-money-styles";
/**
 ...
 */
export declare const MONEY_V4_GROUND_ATTR = "data-xen-v4-money-ground";
/**
 ...
 */
export declare const MONEY_V4_CSS = "\n[data-xen-v4-card][data-xen-v4-money-ground=\"card\"] {\n  background-color: var(--xen-card);\n  color: var(--xen-on-card);\n}\n";
/**
 ...
 * above it.
 */
export declare const SUMMARY_ROW_CLASS: string;
/**
 ...
 */
export declare const SUMMARY_RULE_CLASS = "h-px w-full shrink-0 bg-border";
