 ...
 */
exports.UsageMeterV4 = React.forwardRef(function UsageMeterV4({ kind, used, allowance = 0, unit, decimals = 0, period, warnAt = 0.8, loading = false, className, ...rest }, ref) {
    ...
    if (loading) {
        return ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, cn_1.cn)(card, className), ...rest, children: (0, jsx_runtime_1.jsxs)("div", { "aria-busy": "true", "aria-label": "Loading usage", className: "flex flex-col gap-[var(--xen-space-sm)]", children: [(0, jsx_runtime_1.jsx)("div", { className: "h-4 w-3/5 animate-pulse rounded-[var(--xen-radius-sm)] bg-neutral-100" }), (0, jsx_runtime_1.jsx)("div", { className: "h-2.5 animate-pulse rounded-full bg-neutral-100" })] }) }));
    }
