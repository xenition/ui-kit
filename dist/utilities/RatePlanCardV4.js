 ...
 */
exports.RatePlanCardV4 = React.forwardRef(function RatePlanCardV4({ name, variant = 'fixed', rateCents, unit, term, features, selected = false, currency = 'USD', formatMoney: format = format_1.formatMoney, selectLabel = 'Choose plan', onSelect, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, className: (0, cn_1.cn)('rounded-[var(--xen-radius-lg)] bg-surface border border-border shadow-lg p-5', selected && 'border-2 border-primary ring-2 ring-primary-300 bg-primary/5', className), ...rest, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-[var(--xen-space-md)]", children: [(0, jsx_runtime_1.jsx)("span", { className: "flex h-12 w-12 items-center justify-center rounded-[var(--xen-radius-md)] bg-gradient-to-br from-primary-400 to-primary-700", children: (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: vd.glyph, size: "xl", color: "onPrimary", "aria-label": vd.label }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-1 flex-col gap-0.5", children: [(0, jsx_runtime_1.jsx)("span", { className: "truncate text-lg font-bold text-on-surface", children: name }), (0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-muted", children: [vd.label, term != null ? ` · ${term}` : ''] })] }), selected ? ((0, jsx_runtime_1.jsx)(primitives_1.Badge, { tone: "primary", variant: "soft", size: "sm", children: "\u2713 Current" })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-[var(--xen-space-md)] flex items-baseline gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-2xl font-bold text-primary", children: format(rate, currency) }), (0, jsx_runtime_1.jsxs)("span", { className: "text-sm text-muted", children: ["/", unit] })] }), rows.length > 0 ? ((0, jsx_runtime_1.jsx)("ul", { className: "mt-[var(--xen-space-md)] flex flex-col gap-[var(--xen-space-xs)]", children: rows.map((f, i) => ((0, jsx_runtime_1.jsxs)("li", { className: "flex items-center gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: "\u2713", size: "sm", color: "success", "aria-label": "included" }), (0, jsx_runtime_1.jsx)("span", { className: "flex-1 text-sm text-on-surface", children: f })] }, `${f}-${i}`))) })) : null, onSelect != null ? ((0, jsx_runtime_1.jsx)(primitives_1.Button, { variant: selected ? 'outline' : 'primary', onClick: selected ? undefined : onSelect, disabled: selected, className: "mt-[var(--xen-space-md)] w-full", children: selected ? 'Current plan' : selectLabel })) : null] }));
});
