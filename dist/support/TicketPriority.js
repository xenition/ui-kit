 ...
 */
exports.TicketPriority = React.forwardRef(function TicketPriority({ level, variant = 'chip', size = 'md', hideLabel = false, className, ...rest }, ref) {
    const spec = LEVEL[level] ?? LEVEL.normal;
    const textSize = size === 'sm' ? 'text-xs' : 'text-sm';
    const a11y = `Priority ${spec.label}`;
    if (variant === 'bars') {
        const barMax = size === 'sm' ? 10 : 14;
        return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, role: "img", "aria-label": a11y, className: (0, cn_1.cn)('inline-flex items-center gap-1', className), ...rest, children: [(0, jsx_runtime_1.jsx)("span", { className: "inline-flex items-end gap-px", "aria-hidden": "true", children: Array.from({ length: TOTAL_BARS }, (_, i) => ((0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('inline-block rounded-[1px]', size === 'sm' ? 'w-[3px]' : 'w-1', i < spec.rank ? spec.fillCls : 'bg-neutral-200'), style: { height: Math.round((barMax * (i + 1)) / TOTAL_BARS) } }, i))) }), hideLabel ? null : ((0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('font-semibold', textSize, spec.textCls), children: spec.label }))] }));
    }
    return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, role: "img", "aria-label": a11y, className: (0, cn_1.cn)('inline-flex items-center gap-1 self-start rounded-full border font-semibold', size === 'sm' ? 'px-2 py-px' : 'px-2.5 py-0.5', textSize, spec.chipCls, className), ...rest, children: [(0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: "font-normal", children: spec.glyph }), hideLabel ? null : (0, jsx_runtime_1.jsx)("span", { children: spec.label })] }));
});
