 ...
 */
exports.ThermostatDial = React.forwardRef(function ThermostatDial({ target, ambient, min = 10, max = 30, step = 0.5, mode = 'heat', unit = '°', size = 200, onTargetChange, offline = false, className, style }, ref) {
