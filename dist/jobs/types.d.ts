...
export declare const EMPLOYMENT_LABEL: Record<EmploymentType, string>;
/** The employment types in display order (for filter bars, pickers). */
export declare const EMPLOYMENT_TYPES: readonly EmploymentType[];
...
export declare const APPLICATION_STAGES: readonly ApplicationStage[];
/** Human labels for each stage (never rely on color alone to convey these). */
export declare const STAGE_LABEL: Record<ApplicationStage, string>;
