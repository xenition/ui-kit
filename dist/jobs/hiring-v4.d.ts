 ...
 */
export declare function salaryParts(min?: number, max?: number): SalaryParts;
 ...
 */
export declare function stageParts<T extends string>(stage: T, stages: readonly T[]): StageParts<T>;
 ...
 */
export declare function relativeParts(iso?: string, now?: number): RelativeParts;
/**
 ...
 */
export declare function isAdverse(state: string): boolean;
//# sourceMappingURL=hiring-v4.d.ts.map