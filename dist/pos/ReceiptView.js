...
function Row({ label, value, strong, tone }) {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex items-baseline justify-between", children: [(0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)(strong ? 'text-base font-bold text-on-surface' : 'text-sm text-muted'), children: label }), (0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('tabular-nums', strong ? 'text-base font-bold text-on-surface' : 'text-sm', tone === 'success' ? 'text-success' : strong ? 'text-on-surface' : 'text-on-surface'), children: value })] }));
}
/**
 ...
 */
exports.ReceiptView = React.forwardRef(function ReceiptView({ merchant, addressLines, orderNumber, timestamp, items, currency = 'USD', subtotalCents, discountCents, taxCents, tipCents, totalCents, tenders, footer, variant = 'full', emptyLabel = 'No items on this receipt', testID, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-receipt-view": "", "data-testid": testID, className: (0, cn_1.cn)('rounded-[var(--xen-radius-lg)] border border-border bg-surface p-[var(--xen-space-lg)]', className), ...rest, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-center gap-0.5", children: [merchant ? ((0, jsx_runtime_1.jsx)("span", { className: "text-center text-lg font-bold text-on-surface", children: merchant })) : null, !compact && addressLines
