...
exports.DishCardV3 = React.forwardRef(function DishCardV3({ name, description, priceCents, currency = 'USD', imageUrl, rating, badges, soldOut = false, loading = false, onClick, onAdd, addLabel = 'Add', soldOutLabel = 'Sold out', formatMoney, className, ...rest }, ref) {
    ...
    const body = ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-1 flex-col gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-baseline gap-[var(--xen-space-sm)]", children: [(0, jsx_runtime_1.jsx)("p", { className: "min-w-0 shrink truncate font-heading font-bold text-on-surface", children: name }), typeof priceCents === 'number' ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: "mb-1 h-0 flex-1 self-end border-b border-dotted border-border", "aria-hidden": "true" }), (0, jsx_runtime_1.jsx)(commerce_1.PriceTag, { cents: priceCents, currency: currency, formatMoney: formatMoney, size: "sm" })] })) : null] }), description ? (0, jsx_runtime_1.jsx)("p", { className: "line-clamp-2 text-sm text-muted", children: description }) : null, (0, jsx_runtime_1.jsxs)("div", { className: "mt-[var(--xen-space-xs)] flex flex-wrap items-center gap-[var(--xen-space-md)]", children: [typeof rating === 'number' ? (0, jsx_runtime_1.jsx)(Rating_1.Rating, { value: rating, size: "sm", showValue: true }) : null, badges ? (0, jsx_runtime_1.jsx)("div", { className: "flex flex-wrap gap-[var(--xen-space-xs)]", children: badges }) : null, soldOut ? ((0, jsx_runtime_1.jsx)("span", { className: "text-sm font-semibold text-danger", children: soldOutLabel })) : onAdd ? ((0, jsx_runtime_1.jsxs)("button", { type: "button", "aria-label": addLabel, onClick: (e) => {
                            e.stopPropagation();
                            onAdd();
