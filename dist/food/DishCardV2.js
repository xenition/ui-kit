...
exports.DishCardV2 = React.forwardRef(function DishCardV2({ name, description, priceCents, currency = 'USD', imageUrl, rating, badges, soldOut = false, loading = false, onClick, onAdd, addLabel = 'Add', soldOutLabel = 'Sold out', formatMoney, className, ...rest }, ref) {
    ...
    const hero = ((0, jsx_runtime_1.jsxs)("div", { className: "relative h-[168px] w-full overflow-visible", children: [(0, jsx_runtime_1.jsx)("div", { className: "h-full w-full overflow-hidden bg-neutral-100", children: imageUrl ? ((0, jsx_runtime_1.jsx)("img", { src: imageUrl, alt: name, loading: "lazy", className: "h-full w-full object-cover" })) : null }), typeof priceCents === 'number' ? ((0, jsx_runtime_1.jsx)("span", { className: "absolute bottom-[var(--xen-space-sm)] left-[var(--xen-space-sm)] rounded-full bg-surface/90 px-[var(--xen-space-sm)] py-[var(--xen-space-xs)] shadow-sm backdrop-blur-sm", children: (0, jsx_runtime_1.jsx)(commerce_1.PriceTag, { cents: priceCents, currency: currency, formatMoney: formatMoney, size: "sm" }) })) : null, soldOut ? ((0, jsx_runtime_1.jsx)("span", { className: "absolute left-[var(--xen-space-sm)] top-[var(--xen-space-sm)] rounded-full bg-danger/10 px-[var(--xen-space-sm)] py-[var(--xen-space-xs)] text-xs font-bold text-danger", children: soldOutLabel })) : null, !soldOut && onAdd ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": addLabel, onClick: (e) => {
                    e.stopPropagation();
                    onAdd();
