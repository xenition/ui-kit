...
exports.TrialBanner = React.forwardRef(function TrialBanner({ title, subtitle, daysLeft, tone = 'info', actionLabel, onAction, icon = '✨', className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, className: (0, cn_1.cn)('flex items-center gap-2 rounded-[var(--xen-radius-md)] px-4 py-2', t.bg, className), ...rest, children: [(0, jsx_runtime_1.jsx)(Icon_1.Icon, { glyph: icon, size: "lg", color: t.iconColor }), (0, jsx_runtime_1.jsxs)("div", { className: "min-w-0 flex-1", children: [(0, jsx_runtime_1.jsx)("p", { className: (0, cn_1.cn)('text-base font-bold', t.fg), children: title }), subtitle ? (0, jsx_runtime_1.jsx)("p", { className: (0, cn_1.cn)('text-sm opacity-90', t.fg), children: subtitle }) : null] }), days != null ? ((0, jsx_runtime_1.jsxs)("span", { className: "rounded-full bg-surface px-2 py-0.5 text-xs font-bold text-on-surface", children: [days, " ", days === 1 ? 'day' : 'days', " left"] })) : null, actionLabel && onAction ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": actionLabel, onClick: onAction, className: (0, cn_1.cn)('text-sm font-bold underline', t.fg), children: actionLabel })) : null] }));
});
