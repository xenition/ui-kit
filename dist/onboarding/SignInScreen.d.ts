...
export declare function signInDomProps(props: SignInScreenProps): React.HTMLAttributes<HTMLDivElement>;
/**
 ...
 */
export declare const SignInScreen: React.ForwardRefExoticComponent<SignInScreenProps & React.RefAttributes<HTMLDivElement>>;
