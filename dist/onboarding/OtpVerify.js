...
exports.OtpVerify = React.forwardRef(function OtpVerify({ destination, length = 6, value, onChange, onVerify, onResend, error, loading = false, resendCountdown, verifyLabel = 'Verify', autoSubmit = true, title, subtitle, illustration, logoGlyph, progress, onBack, onDismiss, resendInterval = DEFAULT_RESEND_INTERVAL, resendNotice, resendPrompt = "Didn't get the code?", className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, className: (0, cn_1.cn)('flex flex-col items-center gap-lg', className), ...rest, children: [showHeader ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex w-full items-center gap-sm", children: [onBack ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "Back", onClick: onBack, className: "flex h-11 w-11 items-center justify-center", children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { name: "chevron-left", size: "xl", color: "onSurface" }) })) : ((0, jsx_runtime_1.jsx)("span", { className: "h-11 w-11" })), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-1 justify-center", children: progress }), onDismiss ? ((0, jsx_runtime_1.jsx)("button", { type: "button", "aria-label": "Dismiss", onClick: onDismiss, className: "flex h-11 w-11 items-center justify-center", children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { name: "close", size: "lg", color: "muted" }) })) : ((0, jsx_runtime_1.jsx)("span", { className: "h-11 w-11" }))] })) : null, showHero ? ((0, jsx_runtime_1.jsx)("div", { className: "flex aspect-[4/3] w-full max-h-[38vh] items-center justify-center overflow-hidden rounded-[var(--xen-radius-lg)] bg-primary-50 p-lg", children: illustration ?? ((0, jsx_runtime_1.jsx)("span", { className: "flex h-[88px] w-[88px] items-center justify-center rounded-full bg-primary", children: (0, jsx_runtime_1.jsx)(Icon_1.Icon, { glyph: logoGlyph, size: "3xl", color: "onPrimary" }) })) })) : null, title != null || subtitle != null ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-sm", children: [title ? ((0, jsx_runtime_1.jsx)("h2", { children: (0, jsx_runtime_1.jsx)(Text_1.Text, { size: "2xl", weight: "bold", tone: "onSurface", align: "center", numberOfLines: 2, className: "block", children: title }) })) : null, subtitle ? ((0, jsx_runtime_1.jsx)(Text_1.Text, { size: "base", tone: "muted", align: "center", numberOfLines: 3, className: "block", children: subtitle })) : null] })) : null, subtitle == null && destination ? ((0, jsx_runtime_1.jsxs)("p", { className: "text-center", children: [(0, jsx_runtime_1.jsxs)(Text_1.Text, { size: "base", tone: "muted", children: ["Enter the code we sent to", ' '] }), (0, jsx_runtime_1.jsx)(Text_1.Text, { size: "base", weight: "bold", tone: "onSurface", children: destination })] })) : null, (0, jsx_runtime_1.jsx)("div", { className: "flex gap-sm", children: chars.map((c, i) => ((0, jsx_runtime_1.jsx)("input", { ref: (el) => {
                        refs.current[i] = el;
