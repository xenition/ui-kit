 ...
 * No literal colors.
 */
exports.ProjectCard = React.forwardRef(function ProjectCard({ title, description, progress, taskCount, assignees = [], dueLabel, dueTone = 'upcoming', onClick, className, }, ref) {
    const pct = typeof progress === 'number' ? Math.max(0, Math.min(100, progress)) : undefined;
    const inner = ((0, jsx_runtime_1.jsxs)(primitives_1.Card, { className: "flex flex-col gap-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-lg font-bold text-on-surface", children: title }), description ? (0, jsx_runtime_1.jsx)("span", { className: "line-clamp-2 text-sm text-muted", children: description }) : null] }), pct != null ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1", children: [(0, jsx_runtime_1.jsx)(primitives_1.Progress, { value: pct, tone: pct >= 100 ? 'success' : 'primary', size: "sm" }), (0, jsx_runtime_1.jsx)("span", { className: "text-xs text-muted", children: `${pct}% complete${typeof taskCount === 'number' ? ` · ${taskCount} tasks` : ''}` })] })) : null, (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-2", children: [(0, jsx_runtime_1.jsx)(AssigneeGroup_1.AssigneeGroup, { assignees: assignees }), dueLabel ? (0, jsx_runtime_1.jsx)(DueDatePill_1.DueDatePill, { label: dueLabel, tone: dueTone }) : null] })] }));
    if (onClick) {
