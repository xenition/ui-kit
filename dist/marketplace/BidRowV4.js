 ...
 */
exports.BidRowV4 = React.forwardRef(function BidRowV4({ bidder, amountCents, currency = 'USD', avatarUrl, timeLabel, leading = false, isYou = false, rank, showAvatar = true, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-v4-row": "", "data-xen-bid-row": "", "aria-label": `${leading ? 'Leading bid, ' : ''}${name}, ${amount}`, className: (0, cn_1.cn)(row_v4_1.ROW_V4_BASE_CLASS, (0, row_v4_1.rowHeightClass)(supporting), (0, row_v4_1.rowGroundClass)(leading), className), ...rest, children: [leadingNode != null ? (0, jsx_runtime_1.jsx)("span", { className: row_v4_1.ROW_V4_LEADING_CLASS, children: leadingNode }) : null, (0, jsx_runtime_1.jsxs)("span", { className: row_v4_1.ROW_V4_TEXT_CLASS, children: [(0, jsx_runtime_1.jsxs)("span", { className: "flex min-w-0 items-center gap-sm", children: [(0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "base", weight: "semibold", tone: ink, numberOfLines: 1, className: "min-w-0", children: name }), leading ? (
                            // `primary`, not `success`: brief rule 3. The word is what carries
                            // the state; the tone only emphasises it.
                            (0, jsx_runtime_1.jsx)(BadgeV4_1.BadgeV4, { tone: "primary", variant: "soft", size: "sm", children: "Leading" })) : null] }), supporting ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "sm", tone: leading ? 'onSelected' : 'mutedText', numberOfLines: 1, children: timeLabel })) : null] }), (0, jsx_runtime_1.jsx)("span", { className: row_v4_1.ROW_V4_TRAILING_CLASS, children: (0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "base", weight: "bold", tone: ink, numeric: "tabular", children: amount }) })] }));
});
