 ...
 */
export declare function nextVerdict(current: SafetyVerdict): SafetyVerdict;
/**
 ...
 */
export declare function clearsHazard(item: {
    hazard?: boolean;
    verdict?: SafetyVerdict;
}, to: SafetyVerdict): boolean;
/** How many blocking hazards are currently failing. */
export declare function hazardCount(items: ReadonlyArray<{
    hazard?: boolean;
    verdict?: SafetyVerdict;
}>): number;
/**
 ...
 */
export declare function isComplete(completed: number, total: number): boolean;
//# sourceMappingURL=verdict-v4.d.ts.map