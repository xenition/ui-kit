...
export interface SoilMoistureCardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title'> {
 ...
 */
export declare const SoilMoistureCard: React.ForwardRefExoticComponent<SoilMoistureCardProps & React.RefAttributes<HTMLDivElement>>;
