...
export interface FarmTaskRowProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onClick' | 'title'> {
 ...
 */
export declare const FarmTaskRow: React.ForwardRefExoticComponent<FarmTaskRowProps & React.RefAttributes<HTMLDivElement>>;
