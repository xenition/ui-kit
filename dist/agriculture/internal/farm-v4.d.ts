 ...
 */
import { clampPercent, metaLine, toneGround, GROUND_TINT, SKELETON_CLASS, TONE_INK, TONE_VAR, type ToneV4 } from '../../primitives/internal/tone-v4';
/** The tones this module's states resolve to. */
export type FarmTone = ToneV4;
export { clampPercent, metaLine, toneGround, GROUND_TINT, SKELETON_CLASS, TONE_INK, TONE_VAR as TONE_FILL, };
