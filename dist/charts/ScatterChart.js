...
exports.ScatterChart = React.forwardRef(function ScatterChart({ data, width = 320, height = 200, color = 'primary', radius = 4, xDomain, yDomain, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("svg", { ref: ref, viewBox: `0 0 ${width} ${height}`, width: "100%", height: height, role: "img", className: (0, cn_1.cn)('inline-block', className), ...rest, children: [(0, jsx_runtime_1.jsx)("line", { x1: pad, y1: height - pad, x2: width - pad, y2: height - pad, stroke: "var(--xen-border)", strokeWidth: 1 }), (0, jsx_runtime_1.jsx)("line", { x1: pad, y1: pad, x2: pad, y2: height - pad, stroke: "var(--xen-border)", strokeWidth: 1 }), data.map((p, i) => ((0, jsx_runtime_1.jsx)("circle", { cx: px(p.x), cy: py(p.y), r: radius, fill: fill, fillOpacity: 0.75 }, i)))] }));
});
