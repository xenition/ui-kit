...
export interface ComparisonBarsV4Props extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title' | 'onSelect'> {
...
export declare const COMPARISON_BARS_V4_STYLE_ID = "xen-v4-comparison-bars-styles";
/**
 ...
 */
export declare const ComparisonBarsV4: React.ForwardRefExoticComponent<ComparisonBarsV4Props & React.RefAttributes<HTMLDivElement>>;
