...
export interface ProgressBarsV4Props extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title' | 'onSelect'> {
...
export declare const PROGRESS_BARS_V4_STYLE_ID = "xen-v4-progress-bars-styles";
/**
 ...
 */
export declare const ProgressBarsV4: React.ForwardRefExoticComponent<ProgressBarsV4Props & React.RefAttributes<HTMLDivElement>>;
