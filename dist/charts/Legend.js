...
exports.Legend = React.forwardRef(function Legend({ items, vertical = false, className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { ref: ref, role: "img", "aria-label": `Legend: ${items.map((it) => it.label).join(', ')}`, className: (0, cn_1.cn)('flex gap-3', vertical ? 'flex-col flex-nowrap' : 'flex-row flex-wrap', className), ...rest, children: items.map((item, i) => ((0, jsx_runtime_1.jsxs)("span", { className: "inline-flex items-center gap-1.5", children: [(0, jsx_runtime_1.jsx)("span", { className: "inline-block h-2.5 w-2.5 rounded-full", style: { backgroundColor: item.color ? (0, internal_1.colorVar)(item.color) : (0, internal_1.seriesColor)(i), opacity: item.opacity ?? 1 } }), (0, jsx_runtime_1.jsx)("span", { className: "text-on-surface text-xs", children: item.label })] }, i))) }));
});
