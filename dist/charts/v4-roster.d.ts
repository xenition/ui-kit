 ...
 * it here.
 */
export declare const CHARTS_V4_ROSTER: readonly ["AreaChartV4", "BarChartV4", "ColumnChartV4", "ComparisonBarsV4", "DonutChartV4", "GaugeChartV4", "HeatmapV4", "HistogramV4", "LegendV4", "LineChartV4", "MiniBarV4", "PieChartV4", "ProgressBarsV4", "ProgressRingV4", "RadarChartV4", "RangeBarV4", "ScatterChartV4", "SparklineV4", "StackedBarV4", "TrendCardV4"];
/** The shared vocabulary an app needs without reaching into `primitives/internal`. */
export declare const CHARTS_V4_SHARED: readonly ["CHART_MARK", "CHART_SERIES_COUNT", "CHART_SCATTER_SERIES_CAP", "CHART_OVERFLOW_LABEL", "foldChartSeries"];
//# sourceMappingURL=v4-roster.d.ts.map