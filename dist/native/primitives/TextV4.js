 ...
 */
function TextV4({ size = 'base', tone = 'onSurface', weight = 'regular', align = 'auto', face = 'auto', measure = false, numeric = 'proportional', numberOfLines, style, children, ...rest }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.Text, { numberOfLines: numberOfLines, style: [
            {
                color: colors[tone],
                fontFamily: resolvedFace === 'heading'
                ...
                ...(numeric === 'tabular' ? { fontVariant: ['tabular-nums'] } : null),
            },
            style,
