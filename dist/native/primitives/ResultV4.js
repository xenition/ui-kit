 ...
 * not `surface`.
 */
function ResultV4({ status = 'success', title, description, actionLabel, onAction, icon, style, }) {
    const { colors, tokens } = (0, theme_1.useXenitionTheme)();
    // `empty` and `404` are not failures — they get a shade, not a signal.
    const semantic = status === 'success' || status === 'error';
    const slots = feedback_v4_1.TONE_SLOTS[status === 'success' ? 'success' : 'danger'];
    const seed = semantic ? colors[slots.fill] : colors.onSurface;
    const disc = (0, v4_depth_1.mixToken)(colors.surface, seed, feedback_v4_1.TINT);
    const mark = (0, color_1.ensureContrast)(semantic ? colors[slots.text] : colors.mutedText, disc, compile_1.MIN_CONTRAST);
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityRole: "summary", style: [
            ...
            style,
        ], children: [icon != null ? ((0, jsx_runtime_1.jsx)(react_native_1.View, { children: icon })) : ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: discSize,
                    height: discSize,
                ...
                }, children: (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: { fontSize: tokens.typography.scale.xl, color: mark }, children: GLYPH[status] }) })), (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                    ...
                    textAlign: 'center',
                    maxWidth: measure,
                }, children: description })) : null, actionLabel ? ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: { marginTop: tokens.spacing.sm }, children: (0, jsx_runtime_1.jsx)(ButtonV4_1.ButtonV4, { size: "lg", onPress: onAction, accessibilityLabel: actionLabel, children: actionLabel }) })) : null] }));
}
