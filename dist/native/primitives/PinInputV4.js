 ...
 */
function PinInputV4({ length = 6, value, onChange, style, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: [{ flexDirection: 'row', gap: metrics.gap }, style], children: chars.map((char, index) => ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: (0, field_v4_1.haloStyle)(theme, { showing: focused === index, accent: colors.ring }), children: (0, jsx_runtime_1.jsx)(react_native_1.TextInput, { ref: (el) => {
                ...
                textContentType: index === 0 ? 'oneTimeCode' : 'none', value: char, onChangeText: (text) => setFrom(index, text), onKeyPress: (event) => onKeyPress(index, event), onFocus: () => setFocused(index), onBlur: () => setFocused((current) => (current === index ? null : current)), style: {
                    width: boxWidth,
