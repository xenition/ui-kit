 ...
 */
function Tabs({ items, value, onValueChange, style }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { accessibilityRole: "tablist", style: [
            ...
            return ((0, jsx_runtime_1.jsx)(react_native_1.Pressable, { accessibilityRole: "tab", accessibilityState: { selected: active }, onPress: () => onValueChange(it.value), style: {
