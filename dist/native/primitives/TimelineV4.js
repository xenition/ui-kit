 ...
 */
function TimelineV4({ items, style }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: [{ flexDirection: 'column' }, style], children: items.map((it, i) => {
            ...
            return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { flexDirection: 'row', gap: tokens.spacing.md }, children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { alignItems: 'center', width: dotSize }, children: [(0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                                    marginTop: tokens.spacing.xs,
                                    width: dotSize,
                                    height: dotSize,
                                    borderRadius: tokens.radius.full,
                                    backgroundColor: colors[DOT[it.tone ?? 'primary']],
                                } }), !last ? ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: { width: 1, flex: 1, backgroundColor: colors.border } })) : null] }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                            flex: 1,
                            minWidth: 0,
                            gap: 2,
                            paddingBottom: last ? 0 : tokens.spacing.lg,
                        }, children: [it.time != null ? (typeof it.time === 'string' ? ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                    color: colors.mutedText,
                                    fontFamily: tokens.typography.fontBody,
                                    fontSize: tokens.typography.scale.xs,
                                    fontVariant: ['tabular-nums'],
                                }, children: it.time })) : (it.time)) : null, typeof it.title === 'string' ? ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                    color: colors.onSurface,
                                    fontFamily: tokens.typography.fontBody,
                                    fontSize: tokens.typography.scale.base,
                                    fontWeight: '600',
                                }, children: it.title })) : (it.title), it.description != null ? (typeof it.description === 'string' ? ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                    color: colors.mutedText,
                                    fontFamily: tokens.typography.fontBody,
                                    fontSize: tokens.typography.scale.xs,
                                }, children: it.description })) : (it.description)) : null] })] }, i));
        }) }));
}
