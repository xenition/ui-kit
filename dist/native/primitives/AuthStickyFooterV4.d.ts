 ...
 * explanation.
 */
export declare function AuthStickyFooterV4({ children, secondaryLabel, onSecondaryPress, secondaryDisabled, safeArea, style, }: AuthStickyFooterV4Props): React.ReactElement | null;
