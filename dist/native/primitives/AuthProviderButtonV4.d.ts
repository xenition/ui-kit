 ...
 * feedback alone.
 */
export declare function AuthProviderButtonV4({ label, glyph, name, loading, compact, fullWidth, disabled, onPress, style, }: AuthProviderButtonV4Props): React.ReactElement;
