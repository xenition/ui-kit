 ...
 * it takes `radius.lg`.
 */
function IconV4({ glyph, name, size = 'lg', color = 'onSurface', badge, badgeShape = 'circle', accessibilityLabel, style, }) {
    ...
    if (badge !== undefined) {
        ground =
            badge === 'solid' ? colors[color] : (0, v4_depth_1.mixToken)(colors.surface, colors[color], SOFT_MIX);
        ...
        ink = (0, color_1.ensureContrast)(seed, ground, compile_1.MIN_CONTRAST);
    }
    ...
    if (badge === undefined) {
        ...
        if (!empty) {
            return ((0, jsx_runtime_1.jsx)(react_native_1.Text, { ...a11y, allowFontScaling: false, style: [glyphStyle, style], children: mark }));
        }
        return ((0, jsx_runtime_1.jsx)(react_native_1.View, { ...a11y, style: [{ alignItems: 'center', justifyContent: 'center' }, style], children: ring }));
    }
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { ...a11y, style: [
            {
                width: diameter,
                height: diameter,
                alignItems: 'center',
            ...
            style,
        ], children: empty ? (ring) : ((0, jsx_runtime_1.jsx)(react_native_1.Text, { allowFontScaling: false, style: glyphStyle, children: mark })) }));
}
