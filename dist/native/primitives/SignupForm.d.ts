 ...
 */
export declare function SignupForm({ onSubmit, onLoginClick, title, subtitle, brandGlyph, minPasswordLength, requireTerms, termsLabel, termsLinks, onTermsLinkPress, submitLabel, submittingLabel, nameLabel, namePlaceholder, emailLabel, emailPlaceholder, passwordLabel, passwordPlaceholder, switchPrompt, switchLabel, }: SignupFormProps): React.ReactElement;
