 ...
 * `useXenitionTheme()`.
 */
export declare function SignupFormV4({ onSubmit, onLoginClick, title, subtitle, brandGlyph, brandIcon, align, titleSize, minPasswordLength, requireTerms, termsLabel, termsLinks, onTermsLinkPress, termsDescription, termsError, splitName, submitLabel, submittingLabel, nameLabel, namePlaceholder, firstNameLabel, firstNamePlaceholder, lastNameLabel, lastNamePlaceholder, requireLastName, emailLabel, emailPlaceholder, passwordLabel, passwordPlaceholder, switchPrompt, switchLabel, providers, onProviderPress, providersLabel, }: SignupFormV4Props): React.ReactElement;
