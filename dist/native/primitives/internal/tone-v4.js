...
exports.toneInk = toneInk;
exports.toneFill = toneFill;
exports.onPair = onPair;
exports.skeletonFill = skeletonFill;
 ...
 */
function skeletonFill(theme) {
    return (0, v4_state_1.stateMix)(theme.colors.card, theme.colors.onCard, 'focus', theme.state);
}
/**
