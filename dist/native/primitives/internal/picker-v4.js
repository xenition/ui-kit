...
exports.PICKER_MOTION = exports.stateLayer = exports.pressLayer = exports.pressFill = exports.RING_ALPHA = exports.TAP_TARGET_KEY = exports.SCRIM_ALPHA = exports.scrimColor = exports.elevationStyle = void 0;
exports.tapTarget = tapTarget;
exports.ringSize = ringSize;
exports.fieldAccent = fieldAccent;
exports.fieldSkin = fieldSkin;
exports.ringWrap = ringWrap;
exports.popoverSkin = popoverSkin;
exports.rangeFill = rangeFill;
exports.brandWash = brandWash;
exports.hitSlopTo = hitSlopTo;
...
Object.defineProperty(exports, "elevationStyle", { enumerable: true, get: function () { return surface_v4_1.elevationStyle; } });
Object.defineProperty(exports, "scrimColor", { enumerable: true, get: function () { return surface_v4_1.scrimColor; } });
Object.defineProperty(exports, "SCRIM_ALPHA", { enumerable: true, get: function () { return surface_v4_1.SCRIM_ALPHA; } });
 ...
 * only by coincidence.
 */
exports.RING_ALPHA = v4_state_1.V4_STATE.focus;
/**
 ...
 */
function fieldAccent(theme, state) {
 ...
 */
function fieldSkin(theme, state = {}) {
...
function ringWrap(theme, state = {}) {
    ...
    return {
        ...
        backgroundColor: state.focused
            ? (0, color_1.withAlpha)(fieldAccent(theme, state), exports.RING_ALPHA)
            : 'transparent',
    };
}
/**
 ...
 */
function popoverSkin(theme, level = 'card') {
    const glassy = theme.depth === 'glass';
    const skin = glassy
        ? (0, glass_1.composeGlass)(theme.glass, theme.colors.surface, 'regular')
        : { backgroundColor: theme.colors.surface, borderColor: theme.colors.border };
    return {
        ...(0, surface_v4_1.elevationStyle)(theme.elevation[level]),
 ...
 * matter.
 */
function brandWash(theme) {
    return (0, v4_depth_1.mixToken)(theme.colors.surface, theme.colors.primary, 0.16);
}
/**
 ...
 */
var state_v4_1 = require("./state-v4");
Object.defineProperty(exports, "pressFill", { enumerable: true, get: function () { return state_v4_1.pressFill; } });
Object.defineProperty(exports, "pressLayer", { enumerable: true, get: function () { return state_v4_1.pressLayer; } });
Object.defineProperty(exports, "stateLayer", { enumerable: true, get: function () { return state_v4_1.stateLayer; } });
/**
...
exports.PICKER_MOTION = {
    ...
    popover: motion_v4_1.V4_MOTION.standard,
    /** A swatch ring, a chip, a thumb's press halo. M3 `quick` — micro-feedback. */
    feedback: motion_v4_1.V4_MOTION.quick,
};
/**
 ...
 */
function hitSlopTo(theme, glyph) {
