 ...
 * halo on a dark page.
 */
export declare const FIELD_HALO_ALPHA: number;
/**
...
export declare function fieldMetrics(theme: XenitionNativeTheme): FieldV4Metrics;
/**
 ...
 */
export declare function fieldAccent(theme: XenitionNativeTheme, invalid: boolean): string;
/**
 ...
 */
export declare function haloStyle(theme: XenitionNativeTheme, options: {
    showing: boolean;
    accent: string;
    radius?: number;
}): ViewStyle;
 ...
 */
export declare function fieldBorder(theme: XenitionNativeTheme, options: {
    invalid: boolean;
    focused: boolean;
}): {
    borderWidth: number;
