 ...
 */
export declare function tapTarget(theme: XenitionNativeTheme): number;
/** Alias for the common `tapTarget()` value, for docs that want to name it. */
export declare const TAP_TARGET_KEY: "2xl";
/** The reserved focus-halo thickness — the same one `InputV4` reserves. */
export declare function ringSize(theme: XenitionNativeTheme): number;
/**
 ...
 * only by coincidence.
 */
export declare const RING_ALPHA: number;
 ...
 */
export declare function fieldAccent(theme: XenitionNativeTheme, state: FieldState): string;
/**
 ...
 */
export declare function fieldSkin(theme: XenitionNativeTheme, state?: FieldState): ViewStyle;
/**
 ...
 * in both schemes.
 */
export declare function ringWrap(theme: XenitionNativeTheme, state?: FieldState): ViewStyle;
/**
 ...
 */
export declare function popoverSkin(theme: XenitionNativeTheme, level?: 'card' | 'sheet'): ViewStyle;
/**
 ...
 */
export declare function rangeFill(theme: XenitionNativeTheme): string;
/**
 ...
 * matter.
 */
export declare function brandWash(theme: XenitionNativeTheme): string;
/**
 ...
 */
export declare function hitSlopTo(theme: XenitionNativeTheme, glyph: number): number;
