 ...
 */
export declare function elevationStyle(token: ElevationToken): ViewStyle;
/**
 ...
 */
export declare const SCRIM_ALPHA = 0.44;
/** The scrim fill for the active scheme — dark in both, by construction. */
export declare function scrimColor(theme: XenitionNativeTheme, alpha?: number): string;
/**
 ...
 */
export declare function panelSkin(theme: XenitionNativeTheme): ViewStyle;
/**
