...
export declare function easingOf(easing: readonly number[]): EasingFunction;
/**
 ...
 */
export declare function disabledOpacity(state: StateLayerTokens, disabled: boolean | undefined): number;
/**
