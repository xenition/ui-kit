...
function ForgotPasswordFormV4({ onSubmit, onLoginClick, title = 'Reset password', subtitle, brandGlyph, brandIcon, align = 'left', submitLabel = 'Send reset link', submittingLabel = 'Sending…', sentMessage = 'Check your email for a reset link.', sentTitle = 'Check your inbox', resendPrompt = "Didn't get the email?", resendLabel = 'Resend link', resendable = true, emailLabel = 'Email', emailPlaceholder = 'you@example.com', backLabel = 'Back to sign in', backPrompt, style, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(AuthCardV4_1.AuthCardV4, { title: sent ? sentTitle : title, 
        ...
        subtitle: sent ? undefined : subtitle, brandGlyph: brandGlyph, brandIcon: brandIcon, align: align, style: style, footer: onLoginClick ? ((0, jsx_runtime_1.jsx)(AuthSwitchFooterV4_1.AuthSwitchFooterV4, { prompt: backPrompt, label: backLabel, onPress: onLoginClick })) : undefined, children: sent ? ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityLiveRegion: "polite", accessibilityRole: "summary", testID: "xen-v4-forgot-sent", style: { width: '100%', gap: tokens.spacing.md }, children: [submitError ? (0, jsx_runtime_1.jsx)(AlertV4_1.AlertV4, { tone: "danger", children: submitError }) : null, (0, jsx_runtime_1.jsx)(StatusMessageV4_1.StatusMessageV4, { state: "empty", message: sentMessage }), sentTo ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "sm", weight: "semibold", align: "center", testID: "xen-v4-forgot-address", children: sentTo })) : null, resendable ? ((0, jsx_runtime_1.jsx)(AuthSwitchFooterV4_1.AuthSwitchFooterV4, { prompt: resendPrompt, label: resending ? submittingLabel : resendLabel, onPress: () => {
                        void handleResend();
                    }, disabled: resending })) : null] })) : ((0, jsx_runtime_1.jsxs)(FormV4_1.FormV4, { testID: "xen-v4-forgot-form", children: [submitError ? (0, jsx_runtime_1.jsx)(AlertV4_1.AlertV4, { tone: "danger", children: submitError }) : null, (0, jsx_runtime_1.jsx)(AuthFieldV4_1.AuthFieldV4, { label: emailLabel, icon: "mail", accessibilityLabel: emailLabel, keyboardType: "email-address", autoCapitalize: "none", autoComplete: "email", textContentType: "emailAddress", clearable: true, error: form.errors.email, value: form.values.email, onChangeText: (t) => form.setValue('email', t), placeholder: emailPlaceholder }), (0, jsx_runtime_1.jsx)(AuthSubmitButtonV4_1.AuthSubmitButtonV4, { label: submitLabel, busyLabel: submittingLabel, onPress: () => {
                        void form.handleSubmit();
                    }, loading: form.submitting, trailingArrow: false })] })) }));
}
