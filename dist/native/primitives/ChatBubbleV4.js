...
exports.ChatBubbleV4 = ChatBubbleV4;
 ...
 */
function ChatBubbleV4({ side = 'them', meta, style, children, }) {
    const { colors, tokens } = (0, theme_1.useXenitionTheme)();
    const me = side === 'me';
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [{ gap: tokens.spacing.xs, alignItems: me ? 'flex-end' : 'flex-start' }, style], children: [meta != null ? (typeof meta === 'string' ? ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                    // `mutedText`, not `muted`: an author and a timestamp are text.
                    color: colors.mutedText,
                    fontFamily: tokens.typography.fontBody,
                    fontSize: tokens.typography.scale.xs,
                    paddingHorizontal: tokens.spacing.xs,
                }, children: meta })) : (meta)) : null, (0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    maxWidth: '75%',
