 ...
 */
export declare function PageHeaderV4({ title, subtitle, actions, divided, size, icon, titleLines, subtitleLines, style, ...rest }: PageHeaderV4Props): React.ReactElement | null;
