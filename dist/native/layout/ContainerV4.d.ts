 ...
 */
export declare function ContainerV4({ maxWidth, padding, safeArea, style, children, ...rest }: ContainerV4Props): React.ReactElement;
//# sourceMappingURL=ContainerV4.d.ts.map