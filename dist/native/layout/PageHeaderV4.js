...
exports.PageHeaderV4 = PageHeaderV4;
 ...
 */
function PageHeaderV4({ title, subtitle, actions, divided = false, size = '3xl', icon, titleLines, subtitleLines, style, ...rest }) {
    ...
    if (!hasTitle && !hasSubtitle && !hasIcon && actions == null)
        return null;
    const mark = hasIcon ? (typeof icon === 'string' ? (
    // §4.7's categorical badge. A caller wanting another tone passes its own
    // `IconV4` element instead of a name.
    (0, jsx_runtime_1.jsx)(IconV4_1.IconV4, { name: icon, badge: "soft", color: "primary" })) : (icon)) : null;
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [
            ...
            style,
        ], ...rest, children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                    flexDirection: 'row',
                    alignItems: 'flex-start',
                    gap: tokens.spacing.md,
                    flexGrow: 1,
                ...
                }, children: [mark ? (0, jsx_runtime_1.jsx)(react_native_1.View, { style: { flexShrink: 0 }, children: mark }) : null, (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { flexShrink: 1, flexGrow: 1, gap: tokens.spacing.xs }, children: [hasTitle ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: size, weight: "bold", tone: "onSurface", face: "heading", accessibilityRole: "header", numberOfLines: titleLines, children: title })) : null, hasSubtitle ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "base", tone: "mutedText", face: "body", numberOfLines: subtitleLines, children: subtitle })) : null] })] }), actions != null ? (0, jsx_runtime_1.jsx)(react_native_1.View, { style: { flexShrink: 0 }, children: actions }) : null] }));
}
