 ...
 */
export declare function KeyboardAvoiderV4({ behavior, offset, safeArea, keyboardVerticalOffset, style, children, ...rest }: KeyboardAvoiderV4Props): React.ReactElement;
//# sourceMappingURL=KeyboardAvoiderV4.d.ts.map