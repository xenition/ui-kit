 ...
 */
export declare function CompanyCardV3({ company, following, onToggleFollow, onPress, style, }: CompanyCardV3Props): React.ReactElement;
//# sourceMappingURL=CompanyCardV3.d.ts.map