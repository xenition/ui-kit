 ...
 */
export declare function PaymentRowV2({ amountCents, date, status, method, reference, currency, formatMoney: format, onPress, style, }: PaymentRowV2Props): React.ReactElement;
