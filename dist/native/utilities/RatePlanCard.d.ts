 ...
 */
export declare function RatePlanCard({ name, variant, rateCents, unit, term, features, selected, currency, formatMoney: format, selectLabel, onSelect, style, }: RatePlanCardProps): React.ReactElement;
