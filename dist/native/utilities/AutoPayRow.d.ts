 ...
 */
export declare function AutoPayRow({ label, enabled, onToggle, method, nextChargeDate, amountCents, currency, formatMoney: format, disabled, style, }: AutoPayRowProps): React.ReactElement;
