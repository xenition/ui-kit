 ...
 */
export declare function WeatherAdvisoryV4({ title, message, kind, severity, timeframe, icon, severityLabels, style, }: WeatherAdvisoryV4Props): React.ReactElement | null;
