 ...
 */
export declare function CropCard({ name, variety, icon, stage, health, progress, fieldLabel, harvestLabel, variant, loading, onPress, style, }: CropCardProps): React.ReactElement;
