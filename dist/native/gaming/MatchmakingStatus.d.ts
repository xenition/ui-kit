 ...
 * Token-only.
 */
export declare function MatchmakingStatus({ phase, elapsedSeconds, found, needed, queueLabel, onCancel, onAccept, onRetry, style, }: MatchmakingStatusProps): React.ReactElement;
