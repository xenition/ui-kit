 ...
 */
function WorkoutCard({ title, variant, durationMin, calories, description, completed = false, startLabel = 'Start', onStart, style, }) {
    const { colors, tokens } = (0, theme_1.useXenitionTheme)();
    const meta = WORKOUT_META[variant];
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityLabel: `${meta.label} workout: ${title}${completed ? ', completed' : ''}`, style: [
            {
