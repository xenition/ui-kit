 ...
 */
function SleepBar({ hours, goal = 8, quality, bedtime, wakeTime, appearance = 'classic', style, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.Animated.View, { accessibilityLabel: `Sleep: ${safeHours} hours${safeGoal > 0 ? ` of ${safeGoal}` : ''}${quality ? `, ${QUALITY_LABEL[quality]} quality` : ''}`, style: [
            {
