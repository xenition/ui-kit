 ...
 */
export declare function ProfileHeaderV4({ name, subtitle, avatarUrl, avatar, status, actions, onPress, divided, nameLines, subtitleLines, style, testID, }: ProfileHeaderV4Props): React.ReactElement | null;
