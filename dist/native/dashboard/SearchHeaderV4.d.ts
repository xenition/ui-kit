...
export interface SearchHeaderV4Props extends SearchHeaderProps {
    ...
    divided?: boolean;
    /**
     * Accessible name for the field. Defaults to `placeholder`, which is what the
     * base used, so a bar labelled "Search recipes" is announced as such.
     */
    accessibilityLabel?: string;
    /** Test hook on the outer row. */
    testID?: string;
}
/**
 ...
 */
export declare function SearchHeaderV4({ value, onChangeText, placeholder, onSubmit, actions, leading, onClear, disabled, divided, accessibilityLabel, clearable: _clearable, style, testID, }: SearchHeaderV4Props): React.ReactElement;
