 ...
 */
export declare function rowMetrics(theme: XenitionNativeTheme): RowV4Metrics;
/**
 ...
 */
export declare function rowContainerStyle(theme: XenitionNativeTheme, options?: {
    twoLine?: boolean;
}): ViewStyle;
/**
 ...
 */
export declare function rowLeadingStyle(theme: XenitionNativeTheme): ViewStyle;
/**
 ...
 */
export declare function rowTextStyle(theme: XenitionNativeTheme): ViewStyle;
/**
 ...
 */
export declare function rowTrailingStyle(theme: XenitionNativeTheme): ViewStyle;
/**
 ...
 * strength.
 */
export declare function rowPressFill(theme: XenitionNativeTheme, ground?: string, ink?: string): string;
/**
 ...
 */
export declare function rowGround(theme: XenitionNativeTheme, options?: {
    pressed?: boolean;
    selected?: boolean;
}): string;
/**
