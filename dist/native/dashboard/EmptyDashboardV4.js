...
exports.EmptyDashboardV4 = EmptyDashboardV4;
 ...
 */
function EmptyDashboardV4({ title, message, actionLabel, onAction, icon, iconName, tone = 'primary', style, }) {
    ...
    const mark = icon ??
        (iconName != null ? ((0, jsx_runtime_1.jsx)(IconV4_1.IconV4, { badge: "soft", badgeShape: "circle", color: tone, size: "2xl", name: iconName, style: {
                width: badgeDiameter,
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityLabel: title, style: [{ width: '100%' }, style], children: [(0, jsx_runtime_1.jsx)(EmptyStateV4_1.EmptyStateV4, { icon: mark, title: title, description: message, style: { width: '100%', ...(cta ? { paddingBottom: tokens.spacing.lg } : null) } }), cta ? ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    width: '100%',
                    paddingHorizontal: tokens.spacing.lg,
                    paddingBottom: tokens.spacing['2xl'],
                }, children: (0, jsx_runtime_1.jsx)(ButtonV4_1.ButtonV4, { testID: "xen-v4-empty-cta", onPress: onAction, 
                    /*
                    ...
                    */
                    style: { alignSelf: 'stretch', borderRadius: tokens.radius.full }, children: actionLabel }) })) : null] }));
}
