 ...
 * `useXenitionTheme()`.
 */
export declare function ShiftReportV4({ cashier, registerId, period, grossSalesCents, refundsCents, discountsCents, taxCents, netSalesCents, transactionCount, expectedCashCents, countedCashCents, currency, breakdown, variant, emptyLabel, testID, style, }: ShiftReportV4Props): React.ReactElement;
