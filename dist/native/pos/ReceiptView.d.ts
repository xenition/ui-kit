 ...
 */
export declare function ReceiptView({ merchant, addressLines, orderNumber, timestamp, items, currency, subtotalCents, discountCents, taxCents, tipCents, totalCents, tenders, footer, variant, emptyLabel, testID, style, }: ReceiptViewProps): React.ReactElement;
