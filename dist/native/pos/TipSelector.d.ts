 ...
 */
export declare function TipSelector({ subtotalCents, currency, percents, selectedPercent, customCents, onSelectPercent, onNoTip, onCustom, testID, }: TipSelectorProps): React.ReactElement;
