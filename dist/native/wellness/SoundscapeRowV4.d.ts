 ...
 */
export declare function SoundscapeRowV4({ variant, name, playing, volume, onToggle, onVolumeChange, style, }: SoundscapeRowV4Props): React.ReactElement;
//# sourceMappingURL=SoundscapeRowV4.d.ts.map