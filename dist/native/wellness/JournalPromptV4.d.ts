 ...
 */
export declare function JournalPromptV4({ prompt, category, response, answered, onWrite, onShuffle, writeLabel, style, }: JournalPromptV4Props): React.ReactElement;
//# sourceMappingURL=JournalPromptV4.d.ts.map