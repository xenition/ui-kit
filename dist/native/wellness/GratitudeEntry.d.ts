 ...
 * tint).
 */
export declare function GratitudeEntry({ prompt, value, placeholder, entries, maxLength, onChangeText, onSubmit, onRemove, submitLabel, emptyLabel, style, }: GratitudeEntryProps): React.ReactElement;
