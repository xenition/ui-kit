 ...
 */
function TripSummary({ destination, dates, travelers, items = [], totalCents, currency = 'USD', formatMoney: format = primitives_1.formatMoney, title = 'Trip summary', action, appearance = 'classic', style, }) {
