...
/**
 * A token-fed gradient ground for the photography module's V4 "studio" line.
 ...
 * here. Used for the studio moments (gallery header, shoot-booking peak) and
 * hero image scrims, so the cards, tiles, and rows themselves stay clean.
 */
