 ...
 */
export declare function TransactionRow({ title, subtitle, amountCents, currency, direction, date, icon, iconColor, onPress, style, }: TransactionRowProps): React.ReactElement;
