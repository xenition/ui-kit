 ...
 */
function SpendCategoryRow({ category, amountCents, currency = 'USD', share, icon, color = 'primary', onPress, style, }) {
    ...
    if (!onPress)
        return body;
    return ((0, jsx_runtime_1.jsx)(react_native_1.Pressable, { accessibilityRole: "button", accessibilityLabel: category, onPress: onPress, style: ({ pressed }) => ({ opacity: pressed ? 0.7 : 1 }), children: body }));
}
