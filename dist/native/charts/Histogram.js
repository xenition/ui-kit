 ...
 */
function Histogram({ bins, height = 120, color = 'primary', max, style, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: style, children: [(0, jsx_runtime_1.jsx)(react_native_1.View, { style: { flexDirection: 'row', alignItems: 'flex-end', height }, children: bins.map((count, i) => {
