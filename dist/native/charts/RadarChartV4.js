...
exports.CHART_AREA_FILL_ALPHA = exports.RADAR_SERIES_CAP = void 0;
exports.RadarChartV4 = RadarChartV4;
 ...
 */
function RadarChartV4({ data, axes, series, max, rings = DEFAULT_RINGS, size = 200, title, summary, caption, legend, loading = false, emptyLabel, animate = true, accessibilityLabel, style, }) {
    ...
    */
    ...
    const frame = (plot, legendNode) => ((0, jsx_runtime_1.jsx)(PieChartV4_1.ChartFigureV4, { title: title, summary: summary, caption: caption, legend: legendNode, style: style, children: plot }));
    if (loading)
    ...
    const seriesFill = (i) => {
        ...
        return tone === undefined ? (0, internal_v4_1.chartSlotColor)(palette, slotOf(i)) : (0, PieChartV4_1.toneColorV4)(colors, tone);
    };
    ...
    return frame((0, jsx_runtime_1.jsx)(PieChartV4_1.ChartRevealV4, { animate: animate, children: (0, jsx_runtime_1.jsx)(react_native_1.View, { accessibilityRole: "image", accessibilityLabel: spoken, children: (0, jsx_runtime_1.jsx)(react_native_svg_1.default, { width: size, height: size, viewBox: `0 0 ${size} ${size}`, children: (0, jsx_runtime_1.jsxs)(react_native_svg_1.G, { children: [Array.from({ length: ringCount }, (_, ri) => {
                            const rr = (r * (ri + 1)) / ringCount;
                            return ((0, jsx_runtime_1.jsx)(react_native_svg_1.Polygon, { points: points(Array.from({ length: axisCount }, (_, i) => spoke(c, rr, i, axisCount))), fill: "none", stroke: palette.grid, strokeWidth: 1 }, `ring-${ri}`));
                        }), Array.from({ length: axisCount }, (_, i) => {
                            const [x, y] = spoke(c, r, i, axisCount);
                            return ((0, jsx_runtime_1.jsx)(react_native_svg_1.Line, { x1: c, y1: c, x2: x, y2: y, stroke: palette.axis, strokeWidth: 1 }, `spoke-${i}`));
                        }), rows.map((row, si) => {
                            ...
                            return ((0, jsx_runtime_1.jsx)(react_native_svg_1.Polygon, { points: points(pts), fill: paint, fillOpacity: v4_chart_1.CHART_AREA_FILL_ALPHA, stroke: paint, strokeWidth: v4_chart_1.CHART_MARK.stroke }, series?.[si]?.key ?? `series-${si}`));
                        }), hasLabels
                            ? axes.slice(0, axisCount).map((label, i) => {
                                ...
                                return ((0, jsx_runtime_1.jsx)(react_native_svg_1.Text, { x: x, y: y, fill: colors.mutedText, fontSize: tokens.typography.scale.xs, textAnchor: "middle", children: label }, `axis-${i}`));
                            })
                            : null] }) }) }) }), legendNode);
}
