 ...
 */
function Sparkline({ data, height = 32, color = 'primary', max, accessibilityLabel, style, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { accessibilityRole: "image", accessibilityLabel: accessibilityLabel ?? `Sparkline, ${data.length} points`, style: [{ flexDirection: 'row', alignItems: 'flex-end', height, gap: 1 }, style], children: data.map((value, i) => {
