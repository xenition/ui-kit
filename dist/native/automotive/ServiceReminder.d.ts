 ...
 */
export declare function ServiceReminder({ service, urgency, glyph, dueLabel, mileageLabel, detail, variant, actionLabel, onAction, onDismiss, style, }: ServiceReminderProps): React.ReactElement;
