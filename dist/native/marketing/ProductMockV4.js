...
exports.ProductMockV4 = ProductMockV4;
 ...
 * literals.
 */
function ProductMockV4({ variant = 'analytics', title, kpis, chart, feed, live = 'LIVE', footnote, style, }) {
    ...
    const wellBg = (0, color_1.withAlpha)(colors.primary, 0.06);
    const canvasBg = (0, color_1.withAlpha)(colors.primary, 0.04);
                        ...
                        borderBottomColor: colors.border,
                                ...
                                borderLeftColor: colors.border,
                                        ...
                                        backgroundColor: (0, color_1.withAlpha)(colors.primary, 0.05),
                                                ...
                                                marginTop: 'auto',
                                                height: 1,
                                                backgroundColor: (0, color_1.withAlpha)(tokens.ramps.primary[500], 0.4),
