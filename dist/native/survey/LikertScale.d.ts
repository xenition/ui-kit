 ...
 * literal colors.
 */
export declare function LikertScale({ points, value, onChange, minLabel, maxLabel, accessibilityLabel, variant, disabled, style, }: LikertScaleProps): React.ReactElement;
