 ...
 */
export declare function NFTCardV3({ name, collection, image, floorAmount, floorSymbol, floorDecimals, network, loading, onPress, style, }: NFTCardV3Props): React.ReactElement;
