 ...
 */
export declare function WalletCardV3({ address, label, balanceCents, currency, nativeAmount, nativeSymbol, nativeDecimals, kind, loading, onCopy, onPress, style, }: WalletCardV3Props): React.ReactElement;
