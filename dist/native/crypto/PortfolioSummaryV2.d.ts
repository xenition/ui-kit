 ...
 */
export declare function PortfolioSummaryV2({ totalCents, currency, changeCents, changePct, allocations, loading, style, }: PortfolioSummaryV2Props): React.ReactElement;
