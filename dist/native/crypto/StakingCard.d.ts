 ...
 */
export declare function StakingCard({ symbol, name, stakedAmount, decimals, stakedValueCents, currency, apy, rewardsAmount, status, onClaim, onUnstake, loading, style, }: StakingCardProps): React.ReactElement;
