...
import { countdownParts, countdownSentence, dayNumber, monthName, remainingParts, seatParts, weekdayName } from '../../../events/schedule-v4';
export { countdownParts, countdownSentence, dayNumber, monthName, onPair, remainingParts, seatParts, skeletonFill, toneFill, toneInk, weekdayName, };
export type { ToneV4 };
/**
