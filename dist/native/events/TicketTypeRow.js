...
exports.TicketTypeRow = TicketTypeRow;
 ...
 * literal colors.
 */
function TicketTypeRow({ name, price, description, remaining, soldOut, selected = false, onSelect, disabled = false, style, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.Pressable, { accessibilityRole: "radio", accessibilityState: { selected, disabled: isDisabled }, accessibilityLabel: `${name}, ${price}${isSoldOut ? ', sold out' : ''}`, disabled: isDisabled, onPress: onSelect, style: ({ pressed }) => [
            {
                flexDirection: 'row',
                alignItems: 'center',
