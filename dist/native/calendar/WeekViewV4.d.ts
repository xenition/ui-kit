 ...
 */
export declare function WeekViewV4({ week, events, selected, today, weekStartsOn, startHour, endHour, hourHeight, locale, now, nowLabel, todayLabel, onSelectDate, onSelectEvent, selectedEventId, style, }: WeekViewV4Props): React.ReactElement;
