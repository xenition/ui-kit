 ...
 */
export declare function QuizQuestion({ prompt, choices, questionNumber, totalQuestions, selectedId, review, onSelect, hint, style, }: QuizQuestionProps): React.ReactElement;
