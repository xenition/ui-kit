 ...
 */
function StreakBadge({ count, unit = 'day', tone = 'warn', glyph = '🔥', size = 'md', emptyLabel = 'Start your streak', style, }) {
    ...
    if (count <= 0) {
        return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityLabel: emptyLabel, style: [
                ...
                style,
            ], children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { allowFontScaling: false, style: { fontSize: tokens.typography.scale.base, opacity: 0.5 }, children: glyph }), (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: { color: colors.muted, fontSize: tokens.typography.scale.sm }, children: emptyLabel })] }));
    }
    const unitLabel = `${unit}${count === 1 ? '' : 's'}`;
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { accessibilityLabel: `${count} ${unitLabel} streak`, style: [
            {
                flexDirection: 'row',
                alignItems: 'baseline',
                gap: tokens.spacing.xs,
