 ...
 */
export declare function CartLineItemV4({ title, variantTitle, quantity, unitPriceCents, compareAtUnitPriceCents, currency, imageUrl, imageAlt, slug, onQuantityChange, onRemove, min, max, removeLabel, formatMoney: format, style, }: CartLineItemV4Props): React.ReactElement | null;
