 ...
 */
export declare function ProductCardV3({ title, priceCents, currency, compareAtCents, imageUrl, imageAlt, slug, onPress, onAdd, addLabel, formatMoney, style, }: ProductCardV3Props): React.ReactElement;
