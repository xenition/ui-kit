 ...
 * nowhere else.
 */
export declare function CartSummaryV4({ subtotalCents, shippingCents, taxCents, discountCents, totalCents, currency, onCheckout, checkoutLabel, formatMoney: format, itemCount, note, style, }: CartSummaryV4Props): React.ReactElement;
