 ...
 */
export declare function OrderSummaryV3({ items, subtotalCents, shippingCents, taxCents, totalCents, currency, status, orderNumber, title, formatMoney: format, style, }: OrderSummaryV3Props): React.ReactElement;
