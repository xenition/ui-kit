...
exports.AUCTION_V4_TIMING = void 0;
...
exports.AuctionCardV4 = AuctionCardV4;
 ...
 */
function AuctionCardV4({ title, currentBidCents, currency = 'USD', bidCount = 0, endsAtMs, nowMs, imageUrl, actionLabel = 'Place bid', onPlaceBid, variant = 'card', urgentBeforeMs = HOUR_MS, onEnd, raised = true, formatMoney, style, }) {
    ...
    */
    const timerSlot = ((0, jsx_runtime_1.jsx)(react_native_1.View, { accessible: true, accessibilityLiveRegion: "polite", accessibilityLabel: announcement, testID: `xen-v4-auction-countdown-${ended ? 'ended' : urgent ? 'urgent' : 'live'}`, children: (0, jsx_runtime_1.jsx)(react_native_1.View, { importantForAccessibility: "no-hide-descendants", accessibilityElementsHidden: true, children: (0, jsx_runtime_1.jsx)(BadgeV4_1.BadgeV4
            // Rule 3: emphasis is weight and the brand, never `warn` / `danger`.
            , { 
                // Rule 3: emphasis is weight and the brand, never `warn` / `danger`.
                tone: urgent ? 'primary' : 'neutral', variant: ended ? 'outline' : urgent ? 'solid' : 'soft', size: "sm", children: ended ? 'Ended' : `${(0, icon_names_1.resolveIconGlyph)('clock')} ${countdown}` }) }) }));
    const media = compact ? null : ((0, jsx_runtime_1.jsxs)(react_native_1.View, { testID: "xen-v4-auction-media", style: {
            aspectRatio: 16 / 9,
            width: '100%',
            /*
            ...
            */
            ...
            (0, jsx_runtime_1.jsx)(GenerativeCoverV4_1.GenerativeCoverV4, { seed: title, style: { width: '100%', height: '100%' } })), (0, jsx_runtime_1.jsx)(react_native_1.View, { style: { position: 'absolute', top: tokens.spacing.sm, right: tokens.spacing.sm }, children: timerSlot })] }));
    return ((0, jsx_runtime_1.jsxs)(CardV4_1.CardV4, { testID: "xen-v4-auction-card", variant: raised ? 'elevated' : 'outlined', radius: "lg", padding: "none", 
        ...
        style: [{ backgroundColor: colors.card, overflow: 'hidden' }, style], children: [media, (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { padding: tokens.spacing.lg, gap: tokens.spacing.sm }, children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { flexDirection: 'row', alignItems: 'center', gap: tokens.spacing.sm }, children: [(0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "base", weight: "bold", tone: "onCard", numberOfLines: 1, style: { flex: 1 }, children: title }), compact ? timerSlot : null] }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                            flexDirection: 'row',
                            alignItems: 'flex-end',
                            justifyContent: 'space-between',
                            gap: tokens.spacing.md,
                        }, children: [(0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { gap: tokens.spacing.xs }, children: [(0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "xs", tone: "mutedText", children: "Current bid" }), (0, jsx_runtime_1.jsx)(PriceTagV4_1.PriceTagV4, { cents: currentBidCents, currency: currency, formatMoney: formatMoney, size: "lg" })] }), (0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "sm", tone: "mutedText", numeric: "tabular", children: bidCount === 0
                                    ? 'No bids yet'
                                    : `${bidCount.toLocaleString()} ${bidCount === 1 ? 'bid' : 'bids'}` })] }), onPlaceBid != null ? ((0, jsx_runtime_1.jsx)(ButtonV4_1.ButtonV4, { variant: "primary", onPress: onPlaceBid, disabled: ended, children: ended ? 'Auction ended' : actionLabel })) : null] })] }));
}
