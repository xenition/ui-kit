...
exports.CONDITION_V4_LABEL = void 0;
exports.ConditionBadgeV4 = ConditionBadgeV4;
 ...
 */
function ConditionBadgeV4({ condition, variant = 'soft', size = 'md', label, showIcon = true, accessibilityLabel, style, }) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.View, { accessible: true, accessibilityLabel: accessibilityLabel ?? text, testID: `xen-v4-condition-badge-${condition}`, style: { alignSelf: 'flex-start' }, children: (0, jsx_runtime_1.jsx)(BadgeV4_1.BadgeV4, { tone: tone, variant: variant, size: size, style: style, children: glyph === '' ? text : `${glyph} ${text}` }) }));
}
