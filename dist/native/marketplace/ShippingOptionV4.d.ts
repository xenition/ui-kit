 ...
 */
export declare function ShippingOptionV4({ label, priceCents, currency, eta, glyph, icon, freeLabel, selected, disabled, onSelect, style, }: ShippingOptionV4Props): React.ReactElement | null;
