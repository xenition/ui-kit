 ...
 */
export declare function StylistCard({ name, role, specialties, avatarUrl, rating, reviewCount, priceFromCents, currency, formatMoney: format, availability, fullyBooked, variant, loading, bookLabel, onBook, onPress, style, }: StylistCardProps): React.ReactElement;
