 ...
 */
export declare function PriceListRow({ label, priceCents, currency, fromPrice, note, durationMin, compareAtCents, variant, formatMoney: format, style, }: PriceListRowProps): React.ReactElement;
