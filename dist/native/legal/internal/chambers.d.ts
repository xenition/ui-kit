...
export declare function chambersGradient(r: Ramps): [string, string, string];
/** Near-white primary ink for text/icons on the gradient ground. */
export declare function chambersInk(r: Ramps): string;
/** Softer secondary ink on the gradient ground. */
export declare function chambersInkSoft(r: Ramps): string;
/** Frosted translucent tile fill sitting on the gradient (glass chips). */
export declare function chambersTile(r: Ramps, alpha?: number): string;
/** Hairline/edge for a frosted tile on the gradient ground. */
export declare function chambersBorder(r: Ramps, alpha?: number): string;
export {};
//# sourceMappingURL=chambers.d.ts.map