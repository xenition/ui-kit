 ...
 */
export declare function RetainerBalance({ balanceCents, initialCents, lowThresholdCents, currency, status, label, loading, variant, onReplenish, testID, style, }: RetainerBalanceProps): React.ReactElement;
