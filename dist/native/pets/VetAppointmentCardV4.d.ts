 ...
 */
export declare function VetAppointmentCardV4({ vetName, clinic, reason, date, time, status, petName, notes, actionLabel, onAction, onCancel, style, variant, }: VetAppointmentCardV4Props): React.ReactElement;
