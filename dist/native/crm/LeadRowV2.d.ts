 ...
 */
export declare function LeadRowV2({ name, company, temperature, valueCents, currency, score, avatarUrl, selected, onPress, testID, style, }: LeadRowV2Props): React.ReactElement;
