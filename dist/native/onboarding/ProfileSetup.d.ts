 ...
 */
export declare function ProfileSetup({ name, avatarUri, onEditAvatar, fields, values, onChangeField, title, saveLabel, onSave, loading, skipLabel, onSkip, style, }: ProfileSetupProps): React.ReactElement;
