 ...
 */
export declare function PaywallFeatureRows({ rows, heading, rail, dense, style, }: PaywallFeatureRowsProps): React.ReactElement | null;
/**
 ...
 */
export declare function PaywallFooter({ ctaLabel, onSubscribe, loading, footnote, dismissLabel, onDismiss, }: Pick<PaywallScreenProps, 'ctaLabel' | 'onSubscribe' | 'loading' | 'footnote' | 'dismissLabel' | 'onDismiss'> & {
    ctaLabel: string;
}): React.ReactElement;
/**
 ...
 */
export declare function PaywallScreen({ title, subtitle, illustration, logoGlyph, showHero, features, featuresTitle, featureRail, valueFraming, valueProps, plans, selectedPlanId, onSelectPlan, billingPeriod, onBillingPeriodChange, annualSavingsLabel, trial, ctaLabel, onSubscribe, loading, footnote, dismissLabel, onDismiss, style, }: PaywallScreenProps): React.ReactElement;
