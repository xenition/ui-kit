 ...
 */
export declare function WelcomeScreenV2({ title, subtitle, logoGlyph, illustration, primaryLabel, onGetStarted, secondaryLabel, onSecondary, onBack, onDismiss, stepCount, stepIndex, loading, style, }: WelcomeScreenV2Props): React.ReactElement;
