 ...
 * colors.
 */
export declare function OtpVerify({ destination, length, value, onChange, onVerify, onResend, error, loading, resendCountdown, verifyLabel, autoSubmit, title, subtitle, illustration, logoGlyph, progress, onBack, onDismiss, resendInterval, resendNotice, resendPrompt, style, }: OtpVerifyProps): React.ReactElement;
