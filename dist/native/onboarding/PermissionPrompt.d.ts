 ...
 */
export declare function PermissionPrompt({ kind, icon, title, rationale, allowLabel, denyLabel, onAllow, onDeny, state, deniedMessage, fullScreen, illustration, benefits, progress, onBack, onDismiss, grantedMessage, style, }: PermissionPromptProps): React.ReactElement;
