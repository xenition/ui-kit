 ...
 */
export declare function OtpVerifyV3({ destination, length, value, onChange, onVerify, onResend, error, loading, resendCountdown, verifyLabel, autoSubmit, title, subtitle, logoGlyph, progress, onBack, onDismiss, resendInterval, resendNotice, resendPrompt, style, }: OtpVerifyV3Props): React.ReactElement;
