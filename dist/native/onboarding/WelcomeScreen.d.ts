 ...
 */
export declare function WelcomeScreen({ title, subtitle, logoGlyph, illustration, primaryLabel, onGetStarted, secondaryLabel, onSecondary, onBack, onDismiss, stepCount, stepIndex, loading, variant, style, }: WelcomeScreenProps): React.ReactElement;
