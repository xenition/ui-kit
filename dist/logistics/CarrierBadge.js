 ...
 */
exports.CarrierBadge = React.forwardRef(function CarrierBadge({ carrier = 'generic', name, service, variant = 'soft', size = 'md', className, ...rest }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", { ref: ref, role: "img", "aria-label": `Carrier ${label}${service ? `, ${service}` : ''}`, className: (0, cn_1.cn)('inline-flex max-w-max items-center gap-[var(--xen-space-xs)] rounded-full px-[var(--xen-space-sm)] py-0.5', textSize, treatment, className), ...rest, children: [(0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", children: meta.glyph }), (0, jsx_runtime_1.jsx)("span", { className: "font-bold", children: label }), service ? ((0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('text-xs', variant === 'solid' ? internal_1.TONE_ON_TEXT[meta.tone] : 'text-muted'), children: `· ${service}` })) : null] }));
});
