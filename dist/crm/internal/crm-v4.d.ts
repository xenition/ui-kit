 ...
 */
import { clampPercent, metaLine, SKELETON_CLASS, TONE_INK, TONE_ON, type ToneV4 } from '../../primitives/internal/tone-v4';
 ...
 */
export declare function toneInkClass(tone: CrmTone): string;
/**
