...
const rail = (filled) => (0, cn_1.cn)('absolute top-1/2 h-0.5 -translate-y-1/2', filled ? 'bg-primary' : 'bg-border');
/**
 ...
 */
function StepsV4({ steps, current, className }) {
    const lastIndex = steps.length - 1;
    return ((0, jsx_runtime_1.jsx)("ol", { "aria-label": "Progress", className: (0, cn_1.cn)('flex w-full items-start', className), children: steps.map((step, index) => {
            ...
            return ((0, jsx_runtime_1.jsxs)("li", { "aria-current": active ? 'step' : undefined, className: "flex flex-1 flex-col items-center", children: [(0, jsx_runtime_1.jsxs)("div", { className: "relative flex h-xl w-full items-center justify-center", children: [index > 0 && (0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, cn_1.cn)(rail(railInFilled), 'left-0 right-1/2') }), index < lastIndex && ((0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, cn_1.cn)(rail(railOutFilled), 'left-1/2 right-0') })), (0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('relative z-10 flex h-xl w-xl items-center justify-center', 'rounded-[var(--xen-radius-full)] font-body text-xs font-semibold', done
                                    ...
                                    : active
                                        ...
                                        : 'border-2 border-border bg-surface text-muted-text'), children: done ? '✓' : index + 1 })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-xs px-xs text-center", children: [(0, jsx_runtime_1.jsx)("div", { className: (0, cn_1.cn)('font-body text-xs', 
                                // Where you are is the only title at full weight.
                                active ? 'font-semibold' : done ? 'font-medium' : 'font-normal', active || done ? 'text-on-surface' : 'text-muted-text'), children: step.title }), step.description != null && ((0, jsx_runtime_1.jsx)("div", { className: "text-xs text-muted-text", children: step.description }))] })] }, index));
        }) }));
}
