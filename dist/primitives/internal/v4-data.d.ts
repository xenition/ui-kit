 ...
 */
export declare function isNumericText(text: string): boolean;
/**
 ...
 */
export declare function isNumericColumn(values: readonly string[]): boolean;
/**
 ...
 */
export declare const ZEBRA_MIX = 0.04;
/**
 ...
 * definition.
 */
export declare function isControlColumn(header: unknown, hasRender: boolean): boolean;
/**
 ...
 */
export declare const RULE_MIX = 0.18;
/**
 ...
 */
export declare function zebraCss(mix: number): string;
/**
 ...
 */
export declare function primaryTintCss(mix: number): string;
/**
 ...
 */
export declare const HOVER_MIX: number;
/**
 ...
 */
export declare const FOCUS_MIX: number;
/**
 ...
 */
export declare const SELECT_MIX = 0.12;
/** The one `<style>` id every V4 **row**-shaped component shares. */
export declare const V4_ROW_STYLE_ID = "xen-v4-row-styles";
/**
 ...
 */
export declare const V4_ROW_CSS: string;
/** The one `<style>` id every V4 **monospace surface** shares. */
export declare const V4_CODE_STYLE_ID = "xen-v4-code-styles";
/**
 ...
 */
export declare const V4_CODE_CSS: string;
/** The one `<style>` id every V4 table-shaped component shares. */
export declare const V4_TABLE_STYLE_ID = "xen-v4-table-styles";
/**
 ...
 */
export declare const V4_TABLE_CSS: string;
//# sourceMappingURL=v4-data.d.ts.map