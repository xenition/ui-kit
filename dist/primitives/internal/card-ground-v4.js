...
exports.V4_CARD_GROUND_CSS = exports.V4_CARD_GROUND_ATTR = exports.V4_CARD_GROUND_STYLE_ID = void 0;
/** The `<style>` id every V4 card shares. Idempotent. */
exports.V4_CARD_GROUND_STYLE_ID = 'xen-v4-card-ground-styles';
/** Spread onto a `CardV4` to opt it into the card ground. */
exports.V4_CARD_GROUND_ATTR = { 'data-xen-v4-ground': 'card' };
/**
