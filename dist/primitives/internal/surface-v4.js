...
exports.SURFACE_V4_DRAWER_CSS = exports.SURFACE_V4_CSS = exports.SURFACE_MOTION = exports.SCRIM_ALPHA = void 0;
exports.scrimCss = scrimCss;
exports.panelKind = panelKind;
exports.useDepth = useDepth;
 ...
 */
exports.SCRIM_ALPHA = 44;
/** The scrim fill for the active scheme — dark in both, by construction. */
function scrimCss(alphaPercent = exports.SCRIM_ALPHA) {
...
exports.SURFACE_MOTION = {
    sheet: v4_motion_1.V4_MOTION.enter,
    dialog: v4_motion_1.V4_MOTION.standard,
};
/**
...
[data-xen-v4-scrim] {
  ...
  animation: xen-v4-fade-in ${exports.SURFACE_MOTION.dialog}ms ${v4_motion_1.EASE_EXIT};
}
...
[data-xen-v4-sheet] { animation: xen-v4-sheet-in ${exports.SURFACE_MOTION.sheet}ms ${v4_motion_1.EASE_ENTER}; }
[data-xen-v4-dialog] { animation: xen-v4-dialog-in ${exports.SURFACE_MOTION.dialog}ms ${v4_motion_1.EASE_ENTER}; }
...
[data-xen-v4-drawer="left"] { animation: xen-v4-drawer-left ${exports.SURFACE_MOTION.sheet}ms ${v4_motion_1.EASE_ENTER}; }
[data-xen-v4-drawer="right"] { animation: xen-v4-drawer-right ${exports.SURFACE_MOTION.sheet}ms ${v4_motion_1.EASE_ENTER}; }
[data-xen-v4-drawer="top"] { animation: xen-v4-drawer-top ${exports.SURFACE_MOTION.sheet}ms ${v4_motion_1.EASE_ENTER}; }
[data-xen-v4-drawer="bottom"] { animation: xen-v4-drawer-bottom ${exports.SURFACE_MOTION.sheet}ms ${v4_motion_1.EASE_ENTER}; }

@media (prefers-reduced-motion: reduce) {
  [data-xen-v4-drawer] { animation: xen-v4-fade-in ${exports.SURFACE_MOTION.dialog}ms ${v4_motion_1.EASE_EXIT}; }
}
`;
