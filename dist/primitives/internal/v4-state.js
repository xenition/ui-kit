...
exports.V4_DISABLED_SOFT_CLASS = exports.V4_DISABLED_CLASS = exports.V4_STATE_CSS = exports.V4_STATE_STYLE_ID = exports.V4_STATE = void 0;
exports.stateOverlay = stateOverlay;
exports.stateMix = stateMix;
exports.stateCss = stateCss;
exports.surfaceStateCss = surfaceStateCss;
exports.stateGroundVars = stateGroundVars;
const compile_1 = require("../../theme/compile");
const color_1 = require("../../theme/color");
const v4_motion_1 = require("./v4-motion");
const v4_depth_1 = require("./v4-depth");
/**
 ...
 */
exports.V4_STATE = compile_1.STATE_LAYERS;
/**
 ...
 */
function stateOverlay(content, level, state = exports.V4_STATE) {
    const { r, g, b } = (0, color_1.hexToRgb)(content);
 ...
 */
function stateMix(container, content, level, state = exports.V4_STATE) {
    return (0, v4_depth_1.mixToken)(container, content, state[level]);
}
/**
...
exports.V4_STATE_STYLE_ID = 'xen-v4-state-styles';
/**
...
[data-xen-v4-state] {
  ...
  */
  transition: ${(0, v4_motion_1.transitionCss)(['background-color', 'border-color'], v4_motion_1.V4_MOTION.quick)};
}
 ...
 */
function stateGroundVars(ground, ink) {
 ...
 */
exports.V4_DISABLED_CLASS = 'disabled:pointer-events-none disabled:opacity-[0.38]';
/** The same, for a control disabled by a prop rather than the DOM attribute. */
exports.V4_DISABLED_SOFT_CLASS = 'pointer-events-none opacity-[0.38]';
//# sourceMappingURL=v4-state.js.map