...
exports.V4_TABLE_CSS = exports.V4_TABLE_STYLE_ID = exports.V4_CODE_CSS = exports.V4_CODE_STYLE_ID = exports.V4_ROW_CSS = exports.V4_ROW_STYLE_ID = exports.SELECT_MIX = exports.FOCUS_MIX = exports.HOVER_MIX = exports.RULE_MIX = exports.ZEBRA_MIX = void 0;
exports.isNumericText = isNumericText;
exports.isNumericColumn = isNumericColumn;
exports.isControlColumn = isControlColumn;
exports.zebraCss = zebraCss;
exports.primaryTintCss = primaryTintCss;
 ...
 * definition.
 */
function isControlColumn(header, hasRender) {
    if (!hasRender)
        return false;
 ...
 */
exports.HOVER_MIX = v4_state_1.V4_STATE.hover;
/**
 ...
 */
exports.FOCUS_MIX = v4_state_1.V4_STATE.focus;
/**
 ...
 */
exports.SELECT_MIX = 0.12;
/** The one `<style>` id every V4 **row**-shaped component shares. */
exports.V4_ROW_STYLE_ID = 'xen-v4-row-styles';
/**
...
[data-xen-v4-row][data-interactive="true"]:hover {
  background-color: ${zebraCss(exports.HOVER_MIX)};
}
[data-xen-v4-row][data-interactive="true"]:focus-visible {
  background-color: ${zebraCss(exports.FOCUS_MIX)};
}
...
[data-xen-v4-row][data-selected="true"]:hover {
  background-color: ${primaryTintCss(exports.SELECT_MIX)};
}
`;
/** The one `<style>` id every V4 **monospace surface** shares. */
exports.V4_CODE_STYLE_ID = 'xen-v4-code-styles';
/**
 ...
 */
exports.V4_CODE_CSS = `
[data-xen-v4-code-body] { background-color: ${zebraCss(exports.ZEBRA_MIX)}; }
[data-xen-v4-code] [data-xen-v4-gutter] { border-right: 1px solid ${zebraCss(exports.RULE_MIX)}; }
[data-xen-v4-code] [data-xen-v4-copy]:hover { background-color: ${zebraCss(exports.HOVER_MIX)}; }
[data-xen-v4-code] [data-xen-v4-copy]:focus-visible { background-color: ${zebraCss(exports.FOCUS_MIX)}; }
/* One guide per nesting level in a JSON tree — see JsonViewerV4 for why this
   is the one rule that earns itself against §9. */
[data-xen-v4-json-level] { border-left: 1px solid ${zebraCss(exports.RULE_MIX)}; }
[data-xen-v4-json-branch]:hover { background-color: ${zebraCss(exports.HOVER_MIX)}; }
[data-xen-v4-json-branch]:focus-visible { background-color: ${zebraCss(exports.FOCUS_MIX)}; }
`;
/** The one `<style>` id every V4 table-shaped component shares. */
exports.V4_TABLE_STYLE_ID = 'xen-v4-table-styles';
/**
 ...
 */
exports.V4_TABLE_CSS = `
[data-xen-v4-table] {
  --xen-v4-rule: ${zebraCss(exports.RULE_MIX)};
  --xen-v4-zebra: ${zebraCss(exports.ZEBRA_MIX)};
  --xen-v4-hover: ${zebraCss(exports.HOVER_MIX)};
  --xen-v4-focus: ${zebraCss(exports.FOCUS_MIX)};
}
...
`;
//# sourceMappingURL=v4-data.js.map