...
exports.EASE_EXIT = exports.EASE_ENTER = exports.EASE_STANDARD = exports.V4_MOTION = void 0;
exports.easingCss = easingCss;
exports.transitionCss = transitionCss;
 ...
 */
exports.V4_MOTION = compile_1.MOTION;
...
exports.EASE_STANDARD = easingCss(exports.V4_MOTION.easingStandard);
/** `cubic-bezier(0.05, 0.7, 0.1, 1)` — M3 emphasized-decelerate. Arrivals. */
exports.EASE_ENTER = easingCss(exports.V4_MOTION.easingEnter);
/** `cubic-bezier(0.3, 0, 1, 1)` — M3 standard-accelerate. Departures. */
exports.EASE_EXIT = easingCss(exports.V4_MOTION.easingExit);
/**
 ...
 */
function transitionCss(properties, duration = exports.V4_MOTION.standard, easing = exports.EASE_STANDARD) {
    return properties.map((p) => `${p} ${duration}ms ${easing}`).join(', ');
}
//# sourceMappingURL=v4-motion.js.map