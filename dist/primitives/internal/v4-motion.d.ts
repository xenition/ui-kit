 ...
 */
export declare const V4_MOTION: import("../..").MotionTokens;
/** An M3 easing quadruple as a CSS `cubic-bezier()`. */
export declare function easingCss(easing: readonly [number, number, number, number]): string;
...
export declare const EASE_EXIT: string;
/**
 ...
 */
export declare function transitionCss(properties: readonly string[], duration?: number, easing?: string): string;
//# sourceMappingURL=v4-motion.d.ts.map