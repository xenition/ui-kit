...
exports.FIELD_V4_SHELL = exports.FIELD_V4_CSS = exports.FIELD_MOTION = exports.FIELD_HALO_PERCENT = exports.FIELD_V4_STYLE_ID = void 0;
exports.fieldRingVars = fieldRingVars;
exports.fieldBorderClass = fieldBorderClass;
...
exports.FIELD_V4_STYLE_ID = 'xen-v4-field-styles';
/**
 ...
 */
exports.FIELD_HALO_PERCENT = Math.round(v4_state_1.V4_STATE.focus * 100);
/**
 ...
 */
exports.FIELD_MOTION = v4_motion_1.V4_MOTION.standard;
const RING = `var(--xen-v4-ring-color, var(--xen-ring))`;
const HALO = `color-mix(in srgb, ${RING} ${exports.FIELD_HALO_PERCENT}%, transparent)`;
/**
 ...
 * (§36.10).
 */
exports.FIELD_V4_CSS = `
[data-xen-v4-field], [data-xen-v4-shell] {
  transition: ${(0, v4_motion_1.transitionCss)(['border-color', 'box-shadow', 'background-color'], exports.FIELD_MOTION)};
}
 ...
 * `invalid` flag.
 */
function fieldRingVars(invalid) {
    return {
...
function fieldBorderClass(invalid) {
