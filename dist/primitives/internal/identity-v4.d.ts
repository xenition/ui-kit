 ...
 */
export declare const AVATAR_DIAMETER: Record<AvatarSize, string>;
/** Presence-dot diameters, from the same scale. */
export declare const AVATAR_DOT: Record<AvatarSize, string>;
/**
 ...
 */
export declare const MONOGRAM_CLASS: Record<AvatarSize, string>;
export declare const AVATAR_SHAPE: Record<AvatarShape, string>;
/**
 ...
 */
export declare const EYEBROW_TRACKING_CLASS = "tracking-[0.18em]";
/**
