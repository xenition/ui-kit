...
export declare function AuthCardV4({ title, subtitle, children, footer, brandGlyph, brandIcon, align, titleSize, variant, padding, width, brandSize, brandShape, brandLabel, footerDivider, className, }: AuthCardV4Props): React.ReactElement;
