...
exports.ICON_GLYPHS = void 0;
exports.isIconName = isIconName;
exports.resolveIconGlyph = resolveIconGlyph;
/**
...
function isIconName(value) {
    return Object.prototype.hasOwnProperty.call(exports.ICON_GLYPHS, value);
}
/**
...
function resolveIconGlyph(name) {
    return isIconName(name) ? exports.ICON_GLYPHS[name] : name;
}
