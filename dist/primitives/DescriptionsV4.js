 ...
 */
function DescriptionsV4({ items, columns = 1, className, }) {
    return ((0, jsx_runtime_1.jsx)("dl", { className: (0, cn_1.cn)('grid gap-x-[var(--xen-space-xl)] gap-y-[var(--xen-space-lg)]', columns === 2 ? 'sm:grid-cols-2' : 'grid-cols-1', className), children: items.map((it, i) => ((0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-col gap-0.5", children: [(0, jsx_runtime_1.jsx)("dt", { className: "text-xs font-medium text-muted-text", children: it.label }), (0, jsx_runtime_1.jsx)("dd", { className: (0, cn_1.cn)('text-base font-semibold text-on-surface', typeof it.value === 'string' && (0, v4_data_1.isNumericText)(it.value)
                        ? '[font-variant-numeric:tabular-nums]'
                        : null), children: it.value })] }, i))) }));
}
