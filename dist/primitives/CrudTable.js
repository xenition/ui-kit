...
function CrudTable({ title, columns, rows, fields, getId, onCreate, onUpdate, onDelete, toFormValues, loading = false, error = null, searchable = true, pageSize = 10, createLabel = 'New', }) {
    ...
    const actionsCol = {
        key: '__actions',
        header: '',
        render: (row) => ((0, jsx_runtime_1.jsxs)("div", { className: "flex justify-end gap-2", children: [(0, jsx_runtime_1.jsx)(Button_1.Button, { size: "sm", variant: "ghost", onClick: () => openEdit(row), children: "Edit" }), (0, jsx_runtime_1.jsx)(Popconfirm_1.Popconfirm, { trigger: (0, jsx_runtime_1.jsx)(Button_1.Button, { size: "sm", variant: "ghost", children: "Delete" }), message: "Delete this item?", confirmLabel: "Delete", onConfirm: () => onDelete(getId(row)) })] })),
    };
