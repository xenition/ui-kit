...
exports.AuthSubmitButtonV4 = exports.AUTH_SUBMIT_HEIGHT_V4 = void 0;
...
[data-xen-v4-auth-submit] {
  ...
  transition: ${(0, v4_motion_1.transitionCss)(['box-shadow', 'opacity'])},
...
[data-xen-v4-auth-arrow] { transition: ${(0, v4_motion_1.transitionCss)(['transform'], v4_motion_1.V4_MOTION.quick)}; }
...
exports.AuthSubmitButtonV4 = React.forwardRef(function AuthSubmitButtonV4({ label, loading = false, trailingArrow = true, tone = 'default', trailingIcon = 'forward', busyLabel, disabled, type = 'button', className, style, ...rest }, ref) {
    (0, inject_1.injectStyleOnce)('xen-v4-auth-submit-styles', AUTH_SUBMIT_V4_CSS);
    ...
    return ((0, jsx_runtime_1.jsxs)("button", { ref: ref, "data-xen-v4-auth-submit": "", type: type, disabled: disabled === true || loading, "aria-busy": loading || undefined, "aria-label": named ? shown : undefined, className: (0, cn_1.cn)(
        ...
        'inline-flex w-full items-center justify-center gap-sm px-lg font-body', 'focus-visible:outline-none', t.fill, className), style: { ...vars, ...style }, ...rest, children: [named ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { "data-xen-v4-auth-label": "", size: "lg", weight: "semibold", tone: t.on, children: shown })) : null, loading ? ((0, jsx_runtime_1.jsx)(SpinnerV4_1.SpinnerV4, { "data-xen-v4-auth-busy": "", size: "sm", role: undefined, "aria-label": undefined, "aria-hidden": "true" })) : trailingArrow ? ((0, jsx_runtime_1.jsx)(IconV4_1.IconV4, { "data-xen-v4-auth-arrow": "", name: trailingIcon, size: "base", color: t.on })) : null] }));
});
