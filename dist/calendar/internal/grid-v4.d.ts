 ...
 */
import { metaLine, SKELETON_CLASS, TONE_BG, TONE_INK, TONE_ON, TONE_VAR, type ToneV4 } from '../../primitives/internal/tone-v4';
...
export declare const BLOCK_TINT = 16;
/** The soft ground an event block paints, as an inline background value. */
export declare function blockGround(tone: ToneV4): string;
/**
 ...
 */
export declare const GRID_HOUR = "calc(var(--xen-space-2xl) + var(--xen-space-sm))";
export declare const GRID_GUTTER = "var(--xen-space-2xl)";
export declare const GRID_MIN_BLOCK = "calc(var(--xen-space-lg) + var(--xen-space-sm))";
