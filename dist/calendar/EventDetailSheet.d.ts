 ...
 */
export declare function EventDetailSheet({ event, description, recurrenceLabel, timezoneLabel, variant, open, onClose, onEdit, onDelete, className, }: EventDetailSheetProps): React.ReactElement | null;
