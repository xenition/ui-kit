 ...
 */
exports.VolumeFaderV4 = React.forwardRef(function VolumeFaderV4({ value, min = 0, max = 100, step = 1, label, variant = 'labeled', muted = false, unit, disabled = false, onValueChange, onChange, className, ...rest }, ref) {
