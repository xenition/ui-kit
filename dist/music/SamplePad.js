 ...
 * literal colors.
 */
exports.SamplePad = React.forwardRef(function SamplePad({ name, detail, glyph = '♪', peaks, color, index = 0, variant = 'tile', playing = false, loading = false, disabled = false, onClick, className, ...rest }, ref) {
