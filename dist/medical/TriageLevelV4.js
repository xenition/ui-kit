 ...
 */
exports.TriageLevelV4 = React.forwardRef(function TriageLevelV4({ level, label, description, compact = false, className, ...rest }, ref) {
    ...
    if (compact) {
        return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-triage-level": "", "aria-label": a11y, className: (0, cn_1.cn)('inline-flex items-center gap-[var(--xen-space-xs)] self-start rounded-full border border-border bg-surface px-[var(--xen-space-md)] py-[var(--xen-space-xs)] shadow-sm', className), ...rest, children: [(0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, cn_1.cn)('text-sm', toneClass), children: meta.glyph }), (0, jsx_runtime_1.jsxs)("span", { className: (0, cn_1.cn)('text-sm font-bold tabular-nums', toneClass), children: [safe, " \u00B7 ", text] })] }));
    }
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, "data-xen-triage-level": "", "aria-label": a11y, className: (0, cn_1.cn)('flex items-center gap-[var(--xen-space-md)] rounded-[var(--xen-radius-lg)] border border-border bg-surface text-on-surface shadow-sm p-[var(--xen-space-lg)]', className), ...rest, children: [(0, jsx_runtime_1.jsx)("div", { className: "flex h-14 w-14 items-center justify-center rounded-[var(--xen-radius-md)] bg-primary/10", children: (0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('text-3xl font-extrabold tabular-nums', toneClass), children: safe }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-0 flex-1 flex-col gap-0.5", children: [(0, jsx_runtime_1.jsxs)("span", { className: "flex items-center gap-[var(--xen-space-xs)]", children: [(0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", className: (0, cn_1.cn)('text-sm', toneClass), children: meta.glyph }), (0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('text-base font-bold', toneClass), children: text })] }), (0, jsx_runtime_1.jsx)("span", { className: "text-sm text-muted", children: hint })] })] }));
});
