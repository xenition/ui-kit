 ...
 */
exports.ProcessStepsV4 = React.forwardRef(function ProcessStepsV4({ steps, className, ...rest }, ref) {
    return ((0, jsx_runtime_1.jsx)("ol", { ref: ref, "data-xen-process-steps": "", className: (0, cn_1.cn)('flex flex-col gap-[var(--xen-space-lg)] md:flex-row md:items-start', className), ...rest, children: steps.map((step, index) => {
            ...
            return ((0, jsx_runtime_1.jsxs)("li", { "data-xen-process-step": "", className: "relative flex flex-1 gap-[var(--xen-space-md)] md:flex-col md:text-center", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-center md:w-full md:flex-row md:items-center", children: [(0, jsx_runtime_1.jsx)("span", { "data-xen-process-number": "", className: "flex h-12 w-12 shrink-0 items-center justify-center rounded-[var(--xen-radius-full)] bg-primary/10 font-heading text-lg font-extrabold text-primary md:mx-auto", children: step.icon ?? index + 1 }), !isLast ? ((0, jsx_runtime_1.jsx)("span", { "aria-hidden": "true", "data-xen-process-connector": "", className: "mt-[var(--xen-space-xs)] w-px flex-1 bg-border md:mt-0 md:ml-[var(--xen-space-sm)] md:h-px md:w-auto md:flex-1" })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-[var(--xen-space-xs)] pb-[var(--xen-space-md)] md:pb-0", children: [(0, jsx_runtime_1.jsx)("h3", { className: "font-heading text-lg font-extrabold tracking-tight text-on-surface", children: step.title }), step.description !== undefined ? ((0, jsx_runtime_1.jsx)("p", { className: "text-sm leading-relaxed text-muted", children: step.description })) : null] })] }, index));
        }) }));
});
