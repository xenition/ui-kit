...
export interface RideRequestCardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onClick'> {
    /** Rider display name. */
    riderName: string;
 ...
 */
export declare const RideRequestCard: React.ForwardRefExoticComponent<RideRequestCardProps & React.RefAttributes<HTMLDivElement>>;
