...
exports.VERDICT_LABEL = exports.VERDICT_TONE = exports.FOCUS_RING_CLASS = exports.TRACK_VAR = exports.TRACK_CLASS = exports.HEALTH_TILE_CLASS = exports.HEALTH_CARD_CLASS = void 0;
exports.appearanceClass = appearanceClass;
exports.frameClass = frameClass;
exports.appearanceStateVars = appearanceStateVars;
 ...
 * what surface it is.
 */
exports.HEALTH_CARD_CLASS = 'rounded-[var(--xen-radius-lg)] p-lg';
/** The same shell one step down, for a tile rather than a card. */
exports.HEALTH_TILE_CLASS = 'rounded-[var(--xen-radius-md)] p-md';
/**
 ...
 */
function appearanceClass(appearance = 'classic') {
    switch (appearance) {
        case 'elevated':
 ...
 */
function frameClass(appearance = 'classic') {
    return appearance === 'classic'
        ? undefined
        : `${exports.HEALTH_CARD_CLASS} ${appearanceClass(appearance)}`;
}
/**
 ...
 */
function appearanceStateVars(appearance = 'classic') {
    const bare = appearance === 'outline' || appearance === 'minimal';
    return (0, v4_state_1.stateGroundVars)(bare ? 'var(--xen-surface)' : 'var(--xen-card)', bare ? 'var(--xen-on-surface)' : 'var(--xen-on-card)');
}
/**
