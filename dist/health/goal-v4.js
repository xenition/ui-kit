...
exports.goalParts = goalParts;
exports.rangeVerdict = rangeVerdict;
 ...
 */
function goalParts(value, target) {
 ...
 */
function rangeVerdict(value, range) {
    if (!range)
        return undefined;
    const v = finite(value);
 ...
 */
function pluralizeUnit(count, unit, plural) {
    return Math.abs(finite(count)) === 1 ? unit : (plural ?? `${unit}s`);
}
//# sourceMappingURL=goal-v4.js.map