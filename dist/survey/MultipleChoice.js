 ...
 */
exports.MultipleChoice = React.forwardRef(function MultipleChoice({ options, value, onChange, selection = 'single', 'aria-label': ariaLabel = 'Answer options', disabled = false, className, }, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { ref: ref, role: multiple ? 'group' : 'radiogroup', "aria-label": ariaLabel, className: (0, cn_1.cn)('flex flex-col gap-sm', className), children: options.map((opt) => {
            ...
            return ((0, jsx_runtime_1.jsxs)("button", { type: "button", role: multiple ? 'checkbox' : 'radio', "aria-checked": selected, "aria-label": opt.label, disabled: disabled, onClick: () => toggle(opt.id), className: (0, cn_1.cn)('flex items-center gap-sm rounded-md border bg-surface px-md py-sm text-left transition-colors', 'disabled:pointer-events-none disabled:opacity-50 hover:opacity-90', selected ? 'border-primary' : 'border-border'), children: [(0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('flex h-[22px] w-[22px] shrink-0 items-center justify-center', multiple ? 'rounded-sm' : 'rounded-full', selected ? 'bg-primary' : 'border border-border bg-surface'), children: selected ? (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: multiple ? '✓' : '●', size: "xs", color: "onPrimary" }) : null }), opt.icon ? (0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: opt.icon, size: "base", color: "onSurface" }) : null, (0, jsx_runtime_1.jsxs)("span", { className: "flex-1", children: [(0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('block text-base text-on-surface', selected ? 'font-bold' : 'font-medium'), children: opt.label }), opt.description ? ((0, jsx_runtime_1.jsx)("span", { className: "block text-sm text-muted", children: opt.description })) : null] })] }, opt.id));
        }) }));
});
