 ...
 * literal colors.
 */
exports.PollResultBar = React.forwardRef(function PollResultBar({ options, selectedId, showResults = true, onVote, 'aria-label': ariaLabel = 'Poll results', className }, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: ref, role: "list", "aria-label": ariaLabel, className: (0, cn_1.cn)('flex flex-col gap-sm', className), children: [options.map((opt) => {
                ...
                const rowLabel = showResults
                    ...
                    : opt.label;
                const inner = ((0, jsx_runtime_1.jsxs)("div", { "aria-label": rowLabel, className: (0, cn_1.cn)('relative overflow-hidden rounded-md border bg-surface', isPick ? 'border-primary' : 'border-border'), children: [showResults ? ((0, jsx_runtime_1.jsx)("div", { "aria-hidden": "true", className: (0, cn_1.cn)('absolute inset-y-0 left-0 bg-primary', isWinner ? 'opacity-20' : 'opacity-10'), style: { width: `${pct}%` } })) : null, (0, jsx_runtime_1.jsxs)("div", { className: "relative flex items-center gap-sm px-md py-sm", children: [isPick ? ((0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: "\u2713", size: "sm", color: "primary" })) : opt.icon ? ((0, jsx_runtime_1.jsx)(primitives_1.Icon, { glyph: opt.icon, size: "base", color: "onSurface" })) : null, (0, jsx_runtime_1.jsx)("span", { className: (0, cn_1.cn)('flex-1 text-base text-on-surface', isPick || isWinner ? 'font-bold' : 'font-medium'), children: opt.label }), showResults ? ((0, jsx_runtime_1.jsxs)("span", { className: "text-base font-bold text-on-surface", children: [pct, "%"] })) : null] })] }));
            ...
            }), showResults ? ((0, jsx_runtime_1.jsxs)("span", { className: "text-xs text-muted", children: [total, " ", total === 1 ? 'vote' : 'votes'] })) : null] }));
});
