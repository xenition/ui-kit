 ...
 */
exports.Sticky = React.forwardRef(function Sticky({ side = 'top', offset = 0, className, style, ...rest }, ref) {
    const edge = side === 'top' ? { top: offset } : { bottom: offset };
    return ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, cn_1.cn)('sticky z-10', className), style: { ...edge, ...style }, ...rest }));
});
