...
export interface ProductRecommendationProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onClick'> {
    /** Product name. */
    name: string;
 ...
 */
export declare const ProductRecommendation: React.ForwardRefExoticComponent<ProductRecommendationProps & React.RefAttributes<HTMLDivElement>>;
