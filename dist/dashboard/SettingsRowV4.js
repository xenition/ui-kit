 ...
 */
exports.SettingsRowV4 = React.forwardRef(function SettingsRowV4({ label, value, description, rightSlot, onClick, className, leading, icon, iconTone = 'primary', chevron, selected = false, }, ref) {
    ...
    const inner = ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [leadingNode != null ? (0, jsx_runtime_1.jsx)("span", { className: row_v4_1.ROW_V4_LEADING_CLASS, children: leadingNode }) : null, (0, jsx_runtime_1.jsxs)("span", { className: row_v4_1.ROW_V4_TEXT_CLASS, children: [labelled ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "base", weight: "medium", tone: "onSurface", numberOfLines: 1, children: label })) : null, supporting ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "sm", tone: "mutedText", numberOfLines: 1, children: description })) : null] }), hasValue || rightSlot != null || showChevron ? ((0, jsx_runtime_1.jsxs)("span", { className: row_v4_1.ROW_V4_TRAILING_CLASS, children: [hasValue ? ((0, jsx_runtime_1.jsx)(TextV4_1.TextV4, { size: "sm", tone: "mutedText", numberOfLines: 1, children: value })) : null, rightSlot, showChevron ? (
